...
import Gestion from './pages/Home/Gestion';
import { BrowserRouter , Routes , Route , Navigate} from 'react-router-dom';
import Bareme from './pages/Home/Bareme';
import BaremeQuanti from './pages/Home/BaremeQuanti';
import BaremeQuali from './pages/Home/BaremeQuali';
    ...
    <BrowserRouter>
      <Routes>
        <Route path='/' element = { <Home/> }>
          ...
          <Route path='/quanti' element={<BaremeQuanti/>}/>
          <Route path='/quali' element={<BaremeQuali/>}/>
