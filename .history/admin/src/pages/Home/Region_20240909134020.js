  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const geoResponse = await axios.get(`https://financialmodelingprep.com/api/v4/revenue-geographic-segmentation?symbol=AAPL.MX&structure=flat&apikey=7DpR3qkhqfZy2qfQDZZwHrz0Ohd6oRUX`);
        ...
        const productResponse = await axios.get('https://financialmodelingprep.com/api/v4/revenue-product-segmentation?symbol=AAPL.MX&structure=flat&period=annual&apikey=7DpR3qkhqfZy2qfQDZZwHrz0Ohd6oRUX');
