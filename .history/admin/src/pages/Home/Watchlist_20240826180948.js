...
export default function Watchlist() {
  ...
  return (
    <section className="container mt-4">
      ...
      {isFormVisible && (
        <div style={{ position: 'fixed', bottom: '70px', right: '20px', backgroundColor: '#f1f1f1', padding: '20px', borderRadius: '5px', boxShadow: '0px 0px 10px rgba(0, 0, 0, 0.1)', height: `${formHeight}px` }}>
          <form onSubmit={handleEmailSend}>
            <div className="form-group">
              ...
              <input 
                ...
                value={emails.join(', ')} 
                readOnly
                style={{ width: `${emailsWidth}px` }} // Ajuster la largeur du champ en fonction du nombre d'e-mails
              />
            </div>
            <div className="form-group">
