...
export default function Watchlist() {
  ...
  const [emails, setEmails] = useState([]); // état pour les emails
  ...
  useEffect(() => {
    axios.post('http://localhost:4000/getEmails') // Remplacez par l'URL correcte de votre API
      .then(res => {
        setEmails(res.data); // Assurez-vous que `res.data` est un tableau d'emails
      })
