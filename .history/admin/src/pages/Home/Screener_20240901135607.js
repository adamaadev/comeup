...
export default function Screener() {
  ...
  useEffect(() => {
    ...
    if (secondSelectChanged) {
      // Appliquer le filtrage uniquement lorsque le second sélecteur est modifié
      ...
      // Appliquer le filtrage incluant la recherche par texte en cas de changement de la barre de recherche
