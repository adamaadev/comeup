  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const productResponse = await axios.get('https://financialmodelingprep.com/api/v4/revenue-product-segmentation?symbol=AAPLMX&structure=flat&period=annual&apikey=7DpR3qkhqfZy2qfQDZZwHrz0Ohd6oRUX');
