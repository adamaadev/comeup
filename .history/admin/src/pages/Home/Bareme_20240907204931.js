            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left' }}>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style={{ padding: '10px', border: '1px solid #ddd' }}>{financialData.croissance_CA_1_an?.score}</td>
                        <td style={{ padding: '10px', border: '1px solid #ddd' }}>{financialData.croissance_CA_5_ans?.score}</td>
                        <td style={{ padding: '10px', border: '1px solid #ddd' }}>{financialData.croissance_CA_10_ans?.score}</td>
                        <td style={{ padding: '10px', border: '1px solid #ddd' }}>{financialData.fcf_1_year?.score}</td>
                        <td style={{ padding: '10px', border: '1px solid #ddd' }}>{financialData.fcf_5_years?.score}</td>
                        <td style={{ padding: '10px', border: '1px solid #ddd' }}>{financialData.fcf_10_years?.score}</td>
                        <td style={{ padding: '10px', border: '1px solid #ddd' }}>{financialData.croissance_resultat_net_1_an?.score}</td>
                        <td style={{ padding: '10px', border: '1px solid #ddd' }}>{financialData.croissance_resultat_net_5_ans?.score}</td>
                        <td style={{ padding: '10px', border: '1px solid #ddd' }}>{financialData.roce?.score}</td>
                        <td style={{ padding: '10px', border: '1px solid #ddd' }}>{financialData.roce_5_year_avg?.score}</td>
                        <td style={{ padding: '10px', border: '1px solid #ddd' }}>{financialData.fcf_margin_one_year?.score}</td>
                        <td style={{ padding: '10px', border: '1px solid #ddd' }}>{financialData.fcf_margin_five_year?.score}</td>
                        <td style={{ padding: '10px', border: '1px solid #ddd' }}>{financialData.croissance_annualisee?.score}</td>
                        <td style={{ padding: '10px', border: '1px solid #ddd' }}>{financialData.croissance_moyenne?.score}</td>
                        <td style={{ padding: '10px', border: '1px solid #ddd' }}>{financialData.debt_equity?.score}</td>
                        <td style={{ padding: '10px', border: '1px solid #ddd' }}>{financialData.ratio_payout?.score}</td>
                        <td style={{ padding: '10px', border: '1px solid #ddd' }}>{financialData.performance?.score}</td>
                        <td style={{ padding: '10px', border: '1px solid #ddd' }}>{financialData.buyback_yield?.score}</td>
                        <td style={{ padding: '10px', border: '1px solid #ddd' }}>{financialData.rachat_net_moyen?.score}</td>
                        <td style={{ padding: '10px', border: '1px solid #ddd' }}>{financialData.ratio_capex_revenu_net?.score}</td>
                        <td style={{ padding: '10px', border: '1px solid #ddd' }}>{financialData.piotroski_score?.score}</td>
                        <td style={{ padding: '10px', border: '1px solid #ddd' }}>{financialData.nbreannee?.score}</td>
                    </tr>
                </tbody>
            </table>
        </div>
