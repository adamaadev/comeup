        ...
        <tbody>
          {infos.map((company) => (
            <tr key={company.symbol} onClick={() => window.open(`/details/${company.symbol}`, '_blank')}>
              ...
              <td className="text-center" width={100}>{company.pays}</td>
              <td className="text-center" width={100}>{company.secteur}</td>
              <td className="text-center" width={100}>{company.industrie}</td>
              <td className="text-center" width={100}>{formatNumber(company.marketcap)}</td>
              <td className="text-center" width={100}>{company.eligiblePea ? 'Oui' : 'Non'}</td>
