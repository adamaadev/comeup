...
export default function Screener() {
  ...
  const handleFilterChange = (index, field, value) => {
    ...
    applyFilters();  // Appliquer les filtres après modification
  };
  const currentItems = filteredInfos.length > 0 ? filteredInfos.slice(indexOfFirstItem, indexOfLastItem) : infos.slice(indexOfFirstItem, indexOfLastItem);
