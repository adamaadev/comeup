...
>
                ...
                {(provided) => (
                  <th
                    ...
                    style={{
                      ...
                      overflow: 'hidden',
                      verticalAlign: 'middle', // Alignement vertical des en-têtes
                    }}
                  >
  ...
  <tbody>
    {currentItems.map((info, index) => (
      ...
      >
        {columns.map((col, idx) => {
          // Identifier si la colonne est après "Dividende"
          const isAfterDividende = columns.indexOf(col) > columns.indexOf('Dividende');
          ...
          return (
            <td
              ...
              style={{
                ...
                backgroundColor: isAfterDividende ? 'red' : 'transparent', // Appliquer la couleur rouge si la colonne est après "Dividende"
                verticalAlign: 'middle', // Alignement vertical des cellules
              }}
            >
              {col === 'Nom' ? (
                <div className="d-flex align-items-center">
