...
import './Screener.css'; // Make sure this file contains the .text-center class
    ...
    <div className="container mt-4">
      ...
      <table className="table">
        <thead>
          <tr>
            ...
            <th>Secteur</th>
            <th>Industrie</th>
            <th className="text-center" width={200}>Capitalisation (Mds)</th>
            <th className="text-center" width={200}>PEA</th>
            <th className="text-center" width={200}>Dividende</th>
          </tr>
        </thead>
        <tbody>
          {infos.map((company) => (
      ...
      <nav aria-label="Page navigation">
        <ul className="pagination">
          ...
          <li className="page-item">
            <span className="page-link">Page {page} sur {totalPages}</span>
          </li>
          <li className="page-item">
