          ...
          <form onSubmit={handleSubmit}>
            <div className="form-group mb-3">
              ...
              >
                ...
                <option value="grande_scenario">Grand scénario</option>
                <option value="petite_scenario">Petit scénario</option>
                <option value="aucune_scenario">Aucun scénario</option>
              </select>
            </div>
