...
export default function Details() {
  ...
  const data = {
    ...
    datasets: [
      ...
      {
        label: 'Prix juste',
        data: new Array(labels.length).fill(400), // Ligne horizontale à 400
        borderColor: '#0000ff',
        borderWidth: 2,
        borderDash: [5, 5], // Ligne en tirets
        fill: false,
  ...
  const options = {
    ...
    scales: {
      x: {
        type: 'time',
        time: {
          unit: 'year', // Configurer l'unité de temps à "year" pour les labels
