                ...
                {(provided) => (
                  <th
                    ...
                    style={{
                      ...
                      overflow: 'hidden',
                      textAlign: 'center', // Centrer uniquement le texte du th
                    }}
                  >
                    <div className="d-flex align-items-center">
                      <FaGripVertical style={{ marginRight: '8px' }} /> {/* Icone toujours à gauche */}
                      <span style={{ flexGrow: 1 }}>{col === 'Capitalisation' ? 'Capitalisation (MDS)' : ratioNames[col] || col}</span>
                    </div>
                  </th>
                )}
              </Draggable>
