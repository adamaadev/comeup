...
export default function Region({ symbol }) {
  ...
  return (
    <div className="chart-container" style={{ padding: '20px', display: 'flex', justifyContent: 'space-between', height: '100vh' }}>
      {loading && <p>Loading...</p>}
      {error && <p>Error: {error.message}</p>}
      {!loading && !error && (
        <div className="chart-wrapper" style={{ display: 'flex', width: '100%', alignItems: 'center' }}>
          {/* Geographic Revenue Chart */}
          <div style={{ width: '40%', position: 'relative', flexGrow: 1 }}>
          ...
          {/* Empty space between the charts */}
