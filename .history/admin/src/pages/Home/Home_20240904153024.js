  ...
  return (
    <div className="d-flex">
      <div className="flex-grow-1 p-3">
        <header className={`d-flex justify-content-between align-items-center py-3 ${hasScrolled ? 'header-shadow' : ''}`} style={{ position: 'fixed', top: 0, left0 width: '100%', backgroundColor: '#fff', zIndex: 1000 }}>
