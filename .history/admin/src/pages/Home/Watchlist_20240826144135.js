...
import { faEnvelope } from '@fortawesome/free-solid-svg-icons'; // or use faEnvelope from @fortawesome/free-brands-svg-icons
...
export default function Watchlist() {
  ...
  return (
    <section className="container mt-4">
      ...
      <a href="mailto:your-email@gmail.com" style={{ position: 'fixed', bottom: '20px', right: '20px', fontSize: '30px', color: '#DB4437' }}>
