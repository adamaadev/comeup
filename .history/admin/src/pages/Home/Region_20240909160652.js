...
export default function Region({ symbol }) {
  ...
  const renderCustomLabel = ({ cx, cy, midAngle, innerRadius, outerRadius, percent, index }) => {
    ...
    const radius = innerRadius + (outerRadius - innerRadius) * 1.2; // Position the label slightly outside
            ...
            <ResponsiveContainer width="100%" height={400}>
              <PieChart>
                <Pie
                  ...
                  paddingAngle={5}
                  dataKey="value"
                  label={renderCustomLabel} // Adding custom label
                >
            ...
            {logo && (
              <div
                style={{
                  ...
                  width: '120px', // Adjust the width to fit your logo
                  height: '120px', // Adjust the height to fit your logo
                  borderRadius: '50%',
                  overflow: 'hidden',
                  display: 'flex',
