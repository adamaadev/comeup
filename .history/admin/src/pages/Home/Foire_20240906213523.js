...
export default function Foire({ symbol }) {
  ...
  return (
    ...
    <div className="d-flex">
      {/* Composants Douve et Scenario */}
      <div className="mr-4">
        <Douve id={id} symbol={symbol} />
        <Scenario id={id} symbol={symbol} />
        <div className="mt-4">
      ...
      {/* Nouvelle carte alignée à droite */}
      <div className="card" style={{ width: "18rem" }}>
        <div className="card-body">
          <h5 className="card-title">Nouvelle Carte</h5>
          <p className="card-text">
            Ceci est une carte alignée à droite des composants existants.
          </p>
