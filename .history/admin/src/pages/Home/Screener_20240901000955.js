...
export default function Screener() {
  ...
  useEffect(() => {
    const activeFilters = filters.filter(f => f.filterType === 'pays' && f.selectedOption);
    const newColumns = ['Name', 'secteur', 'industrie', 'marketcap', ...filters.map(f => f.filterType).filter(f => f && f !== 'pays')];
