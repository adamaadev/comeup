...
export default function Screener() {
  ...
  const handleQueryChange = (event) => {
    ...
    if (newQuery === '') {
      ...
      const filtered = infos.filter(info => info.symbol.toUpperCase() === newQuery.toUpperCase());
      setFilteredInfos(filtered.slice(0, 1)); // Afficher uniquement le premier résultat exact
    }
  };
