...
export default function Region({ symbol }) {
  ...
  return (
    <div className="chart-container" style={{ padding: '20px' }}>
      ...
      {!loading && !error && (
        <div className="chart-wrapper" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', height: '100vh' }}>
          {/* Geographic Revenue Chart */}
          <div style={{ width: '150%', position: 'relative', marginLeft: '20px' }}>
          ...
          <div style={{ width: '100%', position: 'relative', marginLeft: '150px' }}>
