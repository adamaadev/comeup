  ...
  useEffect(() => {
    axios.get('http://localhost:4000/screener')
      .then(res => {
        ...
        // Extract unique secteurs from the data
        const uniquesecteurs = [...new Set(res.data.map(info => info.secteurs))];
        setsecteurs(uniquesecteurs);

        // Log secteurs to the console
        console.log('secteurs:', uniquesecteurs);
      });
  }, []);
