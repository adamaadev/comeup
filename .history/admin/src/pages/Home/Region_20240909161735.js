...
export default function Region({ symbol }) {
  ...
  const renderCustomLabel = ({ cx, cy, midAngle, innerRadius, outerRadius, percent, index }) => {
    ...
    const radius = outerRadius + 30; // Increase distance for the label
  ...
  <PieChart>
    <Pie
      ...
      cx="50%"
      cy="50%"
      innerRadius={100}  // Ajuster pour correspondre à la taille du logo
      outerRadius={140}  // Ajuster si nécessaire
      fill="#8884d8"
      paddingAngle={2}
      dataKey="value"
    ...
    <Pie
      ...
      cy="50%"
      innerRadius={0}
      outerRadius={100}  // Ajuster cette valeur pour mieux correspondre à la taille du logo
      fill="#fff"
      dataKey="value"
    />
    <Tooltip />
...
{logo && (
  <div
    style={{
      ...
      width: '90px',   // Ajuster la taille pour qu'elle soit plus dynamique par rapport au diagramme
      height: '90px',  // Adapter si nécessaire
      borderRadius: '50%',
      overflow: 'hidden',
      display: 'flex',
            ...
            {logo && (
              <div
                style={{
                  ...
                  left: '50%',
                  transform: 'translate(-50%, -50%)',
                  width: '100px',  // Adjust width to fit logo size
                  height: '100px', // Adjust height to fit logo size
                  borderRadius: '50%',
                  overflow: 'hidden',
                  display: 'flex',
                  justifyContent: 'center',
