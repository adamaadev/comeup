...
export default function Watchlist() {
  ...
  useEffect(() => {
    axios.post('http://localhost:4000/getEmails')
  ...
  return (
    <section className="container mt-4">
      ...
      <a onClick={toggleForm} className="btn btn-primary" style={{ position: 'fixed', bottom: '20px', right: '20px', fontSize: '30px', color: 'white', backgroundColor: '#007bff', borderColor: '#007bff', cursor: 'pointer' }}>
        <FontAwesomeIcon icon={icon} />
      </a>

      {isFormVisible && (
        <div className="card" style={{ position: 'fixed', bottom: '70px', right: '20px', width: '300px', padding: '20px', boxShadow: '0px 0px 10px rgba(0, 0, 0, 0.1)' }}>
