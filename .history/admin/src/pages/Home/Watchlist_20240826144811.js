...
export default function Watchlist() {
  ...
  const toggleForm = () => {
    setIsFormVisible(!isFormVisible); // Toggle l'état du formulaire
  };
  ...
  return (
    <section className="container mt-4">
      ...
      {/* Icone Gmail pour toggler le formulaire */}
      <a onClick={toggleForm} style={{ position: 'fixed', bottom: '20px', right: '20px', fontSize: '30px', color: '
