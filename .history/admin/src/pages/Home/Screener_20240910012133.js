                ...
                {(provided) => (
                  <th
                    ...
                    style={{
                      ...
                      overflow: 'hidden',
                      textAlign: 'center', // Centrer le texte dans le th
                    }}
                  >
        ...
        {columns.map((col, idx) => (
          <td
            ...
            style={{
              ...
              overflow: 'hidden',
              maxWidth: '150px',
              textAlign: ['Capitalisation', 'Pea', 'Dividende', 'Pays', 'Secteurs'].includes(col) ? 'center' : 'left', // Centrer Pays, Secteurs, Capitalisation, Pea, Dividende
            }}
          >
            {col === 'Nom' ? (
