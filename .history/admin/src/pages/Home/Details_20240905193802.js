...
export default function Details() {
  ...
  <div className="card mb-3">
    <div className="card-header d-flex justify-content-between align-items-center">
      <h2 className="card-title">{infos.Nom}</h2>
      {exist ? (
      ...
      <ul className="nav nav-tabs">
        <li className="nav-item">
          <button 
            ...
            style={activeTab === 'profile' ? { borderBottom: '3px solid blue', color: 'blue' } : {}}
          >
            Informations
          </button>
        </li>
        <li className="nav-item">
          <button 
            ...
            style={activeTab === 'news' ? { borderBottom: '3px solid blue', color: 'blue' } : {}}
          >
