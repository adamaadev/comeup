...
export default function Foire({ symbol }) {
  ...
  return (
    <div className="container mt-4">
       <div className="button-group" style={{ display: 'flex', flexWrap: 'wrap', gap: '10px' }}>
    <button style={{ flex: '1 1 calc(10% - 10px)' }}>btn1</button>
    <button style={{ flex: '1 1 calc(50% - 10px)' }}>btn2</button>
    <button style={{ flex: '1 1 calc(50% - 10px)' }}>btn3</button>
    <button style={{ flex: '1 1 calc(50% - 10px)' }}>btn4</button>
  </div>
