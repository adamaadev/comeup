  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const geoResponse = await axios.get('https://financialmodelingprep.com/api/v4/revenue-geographic-segmentation?symbol=MSFT&structure=flat&apikey=7DpR3qkhqfZy2qfQDZZwHrz0Ohd6oRUX');
