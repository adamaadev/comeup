          ...
          {filters.map((filter, index) => (
            <div className="mb-3" key={index}>
              ...
              >
                ...
                <option value="roce_5_year_avg">ROCE 5 ans</option>
                ...
                <option value="croissance_annualisee">Croissance div 1 an</option>
                <option value="croissance_moyenne">Croissance div 5 ans</option>
                ...
                <option value="nbreannee">Nbr année(s) sans diminution</option>
                <option value="rachat_net_moyen">Rachat Net d'actions 5 ans</option>
                <option value="ratio_capex_revenu_net">Capex/Résultat net (5 ans)</option>
                <option value="piotroski_score">Capex/Résultat net (5 ans)</option>
              </select>
