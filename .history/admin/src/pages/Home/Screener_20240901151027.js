...
export default function Screener() {
  ...
  useEffect(() => {
    ...
    const updatedColumns = newColumns.map(col => {
      if (col === 'croissance_CA_1_an') return 'Chiffre d\'affaire 1 an';
      if (col === 'croissance_CA_5_ans') return 'Chiffre d\'affaire 5 ans';
      if (col === 'croissance_CA_10_ans') return 'Chiffre d\'affaire 10 ans';
      if (col === 'croissance_annualisee') return 'Croissance annualisée';
      if (col === 'croissance_moyenne') return 'Croissance moyenne';
      if (col === 'croissance_resultat_net_1_an') return 'Croissance résultat net 1 an';
      if (col === 'croissance_resultat_net_5_ans') return 'Croissance résultat net 5 ans';
      return col;
    });
            ...
            <div className="row mb-2" key={index}>
              <div className="col-md-4">
                ...
                >
                  ...
                  <option value="croissance_CA_1_an">Chiffre d'affaire 1 an</option>
                  <option value="croissance_CA_5_ans">Chiffre d'affaire 5 ans</option>
                  <option value="croissance_CA_10_ans">Chiffre d'affaire 10 ans</option>
              ...
              {['croissance_CA_1_an', 'croissance_CA_5_ans', 'croissance_CA_10_ans', 'croissance_annualisee', 'croissance_moyenne', 'croissance_resultat_net_1_an', 'croissance_resultat_net_5_ans'].includes(filter.filterType) ? (
                <>
                  <div className="col-md-4">
                    <input 
                      type="number" 
