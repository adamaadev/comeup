            ...
            <ResponsiveContainer width="100%" height={400}>
              <PieChart>
                <Pie
                  ...
                  cx="50%"
                  cy="50%"
                  innerRadius={90}  // Adjust the inner radius
                  outerRadius={130}  // Adjust the outer radius
                  fill="#8884d8"
                  paddingAngle={2}
                  dataKey="value"
                  label={renderCustomLabel} // Adding custom label with larger distance
                >
                ...
                <Pie
                  ...
                  cy="50%"
                  innerRadius={0}
                  outerRadius={90} // Adjust to ensure logo fits in the center
                  fill="#fff"
                  dataKey="value"
                />
                <Tooltip />
