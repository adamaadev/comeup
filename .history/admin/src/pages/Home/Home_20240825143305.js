...
import { Box, Button, Typography, TextField, Snackbar, IconButton, Divider, Paper } from '@mui/material';
  ...
  return (
    <Box sx={{ padding: 3 }}>
      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
        ...
        <Box>
          <NavLink to={'/watchlist'} style={{ textDecoration: 'none', marginRight: 16 }}>
            <Button variant="text">Watchlist</Button>
          </NavLink>
          <NavLink to={'/compte'} style={{ textDecoration: 'none', marginRight: 16 }}>
            <Button variant="text">Mon compte</Button>
          </NavLink>
          <Button variant="contained" color="error" onClick={handleLogout}>
            Se déconnecter
          </Button>
          <Button variant="outlined" onClick={toggleEmailList} sx={{ ml: 2 }}>
