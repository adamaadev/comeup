...
export default function Screener() {
  ...
  const handleFilterChange = (index, field, value) => {
    ...
    // Réinitialiser les champs lors de la modification du filtre principal
    if (field === 'filterType') {
          ...
          <tbody>
            {currentItems.map((info, index) => (
              <tr key={index}>
                <td>
                  <img
                    src={`https://financialmodelingprep.com/image-stock/${info.symbol}.png`}
                ...
                <td>{formatNumber(info.marketcap)} Mds €</td>
