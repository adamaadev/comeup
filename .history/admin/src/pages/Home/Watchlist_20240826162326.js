...
export default function Watchlist() {
  ...
  const [icon, setIcon] = useState(faEnvelope); // état pour l'icône
  ...
  const toggleForm = () => {
    ...
    setIcon(isFormVisible ? faEnvelope : faTimes); // Change l'icône en fonction de la visibilité
  };
  ...
  return (
    <section className="container mt-4">
      ...
      {/* Icone pour toggler le formulaire */}
