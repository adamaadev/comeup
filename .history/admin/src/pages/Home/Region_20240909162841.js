  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const geoResponse = await axios.get('https://financialmodelingprep.com/api/v4/revenue-geographication?symbol=AAPL&structure=flat&apikey=7DpR3qkhqfZy2qfQDZZwHrz0Ohd6oRUX');
