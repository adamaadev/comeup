...
export default function Region({ symbol }) {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      setLoading(true);
      setError(null); // Réinitialise l'erreur à chaque nouvelle tentative de chargement
  ...
  return (
    <div className="chart-wrapper" style={{ display: 'flex', width: '100%', alignItems: 'center', justifyContent: 'space-between' }}>
      ...
      {/* Empty space to create separation */}
      <div style={{ width: '45%', position: 'relative' }}>
