...
export default function Login() {
  ...
  <img 
    src={logo} 
    alt="Logo" 
    style={{ maxWidth: '180px', maxHeight: '130px', marginBottom: '10px' }} // Ajustez la valeur ici
  />
  <Typography variant="h4" component="h2" gutterBottom sx={{ marginTop: '10px' }}> // Ajustez la valeur ici
    QQV INVEST
  </Typography>
