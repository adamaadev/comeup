  ...
  return (
    <Box 
      sx={{ 
        maxWidth: 600, 
        margin: 'auto', 
        mt: 4, // Adjusted for responsiveness
        p: 3, 
        borderRadius: 2, 
        width: '90%', // Make sure the box takes up 90% of the container's width on small screens
        '@media (max-width: 600px)': {
          width: '100%', // On very small screens, use full width
          mt: 2 // Reduced margin for small screens
        }
      }}
    >
      ...
      <form onSubmit={submit}>
        <Box sx={{ width: '100%' }}>
          ...
          >
            <Typography variant="body2" sx={{ flexShrink: 0, mb: { xs: 1, sm: 0 } }}>
              <Link to="/forgot-password" style={{ textDecoration: 'none', color: '#007bff' }}>
                Mot de passe oublié ?
              </Link>
            </Typography>
            <Typography variant="body2" sx={{ flexGrow: 1, textAlign: { xs: 'center', sm: 'right' } }}>
