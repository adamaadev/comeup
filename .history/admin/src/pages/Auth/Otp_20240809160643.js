...
export default function Otp() {
  ...
  const [showResend, setShowResend] = useState(false); // Nouvel état pour contrôler la visibilité du bouton
  ...
  useEffect(() => {
    if (!email) {
      ...
      // Déclenche un délai de 15 secondes pour afficher le bouton de renvoi
