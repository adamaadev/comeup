  ...
  return (
    <div className="container mt-4">
      ...
      <form onSubmit={submit}>
        ...
        <div className="mb-3">
          <input type="text" className="form-control" placeholder="Nom d'utilisateur" name="username" autoComplete="off"onChange={change}/>
        </div>
        <div className="mb-3">
        ...
        <div className="mb-3">
        <input type="password" className="form-control" placeholder="Confirmer le mot de passe" name="confirmpassword" autoComplete="off"onChange={change}/>
          <input
            type="password"
