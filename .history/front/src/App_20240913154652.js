  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path='/abonnement' element = {auth  ? <Abonnement/> :<Navigate to="/" /> }/>
        <Route path='/forget' element = {auth && subs? <Navigate to="/" /> : <Forget/>}/>
        <Route path='/reset-password/:token' element = {auth && subs ? <Navigate to="/" /> : <ResetPassword/>}/>
        <Route path='/login' element = {auth && subs? <Navigate to="/" /> :<Login />}/>
        <Route path='/signup' element = { auth  && subs? <Navigate to="/" /> : <Signup />}/>
      </Routes>
    </BrowserRouter>
  )
}
