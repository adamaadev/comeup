    ...
    <div className="col-md-12">
      <Card style={styles.card}>
        ...
        <Card.Footer className="text-center">
          <Button variant="success" onClick={() => setShowDouveModal(true)}>Ajouter une douve</Button>
        </Card.Footer>
      </Card>
    </div>
    {/* Scenarios Card */}
    <div className="col-md-6">
      <div className="card" style={styles.card}>
        ...
        <div className="card-footer text-center">
          <Button variant="danger" onClick={() => setShowScenarioModal(true)}>Ajouter un scénario</Button>
        </div>
      </div>
    </div>
