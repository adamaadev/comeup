  ...
  return (
    <div className="container mt-4">
      ...
      <div className='card' style={{ border: 'none' }}>
        <div className="card-header" style={{ marginLeft : "10px", width : "90%", display: 'flex', justifyContent: 'space-between', alignItems: 'center', backgroundColor: '#f0f0f0', padding: '10px', borderRadius: '5px' }}>
