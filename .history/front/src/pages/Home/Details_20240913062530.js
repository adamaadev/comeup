...
export default function Details() {
  ...
  <div className="card p-3 ms-3" style={{ maxWidth: '900px', maxHeight: '400px', overflowX: 'auto', overflowY: 'auto' }}>
    <div style={{ minWidth: '800px' }}> {/* Assurez-vous que ce contenu est plus large que la carte */}
      <Region symbol={symbol} />
    </div>
  </div>
  <div className="card p-3 ms-3" style={{ maxWidth: '500px', maxHeight: '400px', overflowX: 'auto', overflowY: 'auto' }}>
    <div style={{ minWidth: '800px' }}> {/* Assurez-vous que ce contenu est plus large que la carte */}
      <Region symbol={symbol} />
    </div>
  </div>
