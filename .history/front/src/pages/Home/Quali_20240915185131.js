      ...
      <div className="col-md-6 mb-4">
        <div className="card">
          ...
          <div className="card-body">
            ...
            <p>CAPEX / Résultat Net (moyenne 5 ans) : {infos.ratio_capex_revenu_net || 'N/A'} %</p>
          </div>
        </div>
      </div>
      ...
      <div className="col-md-6 mb-4">
        <div className="card">
          ...
          <div className="card-body">
            ...
            <p>La dividende n'a pas diminué depuis {infos.nbreannee || 'N/A'} an(s) </p>
          </div>
        </div>
      </div>
      ...
      <div className="col-md-6 mb-4">
        <div className="card">
          ...
          <div className="card-body">
            ...
            <p>Total Piotroski Score : {infos.piotroski_score || 'N/A'} / 9 points</p>
            <p>Rachat net moyen d'actions (moyenne 5 ans) : {infos.rachat_net_moyen || 'N/A'}</p>
          </div>
        </div>
      </div>
    </div>
