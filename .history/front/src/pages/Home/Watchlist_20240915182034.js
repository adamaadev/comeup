      ...
      <table className="table" style={{ width: '100%', tableLayout: 'auto' }}>
        <thead>
          <tr>
            ...
            <th className="text-center">Pea</th>
            <th className="text-center">Dividende</th>
            <th className="text-center">Quali-Score</th> {/* Nouvelle colonne pour le score */}
          </tr>
        </thead>
        <tbody>
          {currentItems.map((info, index) => (
            ...
            >
              ...
              <td className="text-center">{info.Capitalisation ? formatNumber(info.Capitalisation) : '-'}</td>
              <td className="text-center">{info.Pea === 1 ? <FaCheck color="green" /> : <FaTimes color="red" />}</td>
              <td className="text-center">{info.Dividende === 1 ? <FaCheck color="green" /> : <FaTimes color="red" />}</td>
              <td className="text-center" style={{ color: getScoreColor(info.score) }}>
                {info.score} / 20
              </td> {/* Affichage du score */}
            </tr>
          ))}
        </tbody>
      </table>
