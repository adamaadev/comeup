...
export default function Vente({ symbol }) {
  ...
  // Predefined colors for product segmentation, as seen in the image.
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        // Fetch logo data (assuming you have the API setup for logo)
  ...
  const renderCustomLabel = ({ cx, cy, midAngle, outerRadius, index }, data) => {
    ...
    const radius = outerRadius + 50; // Extend line length by adjusting this value
