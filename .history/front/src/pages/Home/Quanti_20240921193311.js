...
export default function Quati({ symbol }) {
  ...
  const getProgressColor1 = (performance, croissance_CA_1_an, croissance_CA_5_ans, croissance_CA_10_ans,
            ...
            <div className="col-md-6 col-lg-4 mb-4">
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center' }}>
                ...
                <div className="progress" style={{ height: '13px', borderRadius: '5px', width: '100px', position: 'relative', flexGrow: 1 }}>
                  <div
                    className={`progress-bar ${getProgressColor1(infos.performance)}`}
                    role="progressbar"
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center' }}>
                ...
                <div className="progress" style={{ height: '13px', borderRadius: '5px', width: '100px', position: 'relative', flexGrow: 1 }}>
                  <div
                    className={`progress-bar ${getProgressColor1(infos.croissance_CA_5_ans)}`}
                    role="progressbar"
