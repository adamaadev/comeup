...
export default function Quati({ symbol }) {
  ...
  const getProgressColor20 =( ratio_payout )=>{
    if (ratio_payout < 35) {
      return 'bg-success';
    } else if (ratio_payout >= 35 && ratio_payout < 50) {
      return 'bg-warning';
  ...
  const getProgressColor21 =( piotroski_score )=>{
    if (piotroski_score >= 7 && piotroski_score <= 9) {
      return 'bg-success';
    } else if (piotroski_score >= 5 && piotroski_score <= 6) {
      return 'bg-warning';
          ...
          <div className="row">
            <div className="col-md-6 col-lg-4 mb-4">
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center' }}>
                ...
                <div className="progress" style={{ height: '13px', borderRadius: '5px', width: '100px', position: 'relative', flexGrow: 1 }}>
                  <div
                    className={`progress-bar ${getProgressColor3(infos.croissance_CA_10_ans)}`}
                    role="progressbar"
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center' }}>
                ...
                <div className="progress" style={{ height: '13px', borderRadius: '5px', width: '100px', position: 'relative', flexGrow: 1 }}>
                  <div
                    className={`progress-bar ${getProgressColor4(infos.fcf_1_year)}`}
                    role="progressbar"
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center' }}>
                ...
                <div className="progress" style={{ height: '13px', borderRadius: '5px', width: '100px', position: 'relative', flexGrow: 1 }}>
                  <div
                    className={`progress-bar ${getProgressColor5(infos.fcf_5_years)}`}
                    role="progressbar"
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center' }}>
                ...
                <div className="progress" style={{ height: '13px', borderRadius: '5px', width: '100px', position: 'relative', flexGrow: 1 }}>
                  <div
                    className={`progress-bar ${getProgressColor6(infos.fcf_10_years)}`}
                    role="progressbar"
            ...
            <div className="col-md-6 col-lg-4 mb-4">
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center' }}>
                ...
                <div className="progress" style={{ height: '13px', borderRadius: '5px', width: '100px', position: 'relative', flexGrow: 1 }}>
                  <div
                    className={`progress-bar ${getProgressColor7(infos.croissance_resultat_net_1_an)}`}
                    role="progressbar"
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center' }}>
                ...
                <div className="progress" style={{ height: '13px', borderRadius: '5px', width: '100px', position: 'relative', flexGrow: 1 }}>
                  <div
                    className={`progress-bar ${getProgressColor8(infos.croissance_resultat_net_5_ans)}`}
                    role="progressbar"
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center' }}>
                ...
                <div className="progress" style={{ height: '13px', borderRadius: '5px', width: '100px', position: 'relative', flexGrow: 1 }}>
                  <div
                    className={`progress-bar ${getProgressColor17(infos.ratio_capex_revenu_net)}`}
                    role="progressbar"
            ...
            <div className="col-md-6 col-lg-4 mb-4">
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center' }}>
                ...
                <div className="progress" style={{ height: '13px', borderRadius: '5px', width: '100px', position: 'relative', flexGrow: 1 }}>
                  <div
                    className={`progress-bar ${getProgressColor9(infos.roce)}`}
                    role="progressbar"
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center' }}>
                ...
                <div className="progress" style={{ height: '13px', borderRadius: '5px', width: '100px', position: 'relative', flexGrow: 1 }}>
                  <div
                    className={`progress-bar ${getProgressColor10(infos.roce_5_year_avg)}`}
                    role="progressbar"
  ...
  <div className="progress" style={{ height: '13px', borderRadius: '5px', width: '100px', position: 'relative', flexGrow: 1 }}>
    <div
      className={`progress-bar ${getProgressColor11(infos.fcf_margin_one_year)}`}
      role="progressbar"
      style={{ width: `${infos.fcf_margin_one_year.toFixed(2)}%` }} // Conversion en chaîne avec pourcentage
      aria-valuenow={infos.fcf_margin_one_year}
      aria-valuemin="0"
      aria-valuemax="100"
    >
      <span style={{ position: 'absolute', left: '50%', transform: 'translateX(-50%)', color: 'Black' }}>
        {infos.fcf_margin_one_year.toFixed(2)}% {/* Affichage avec 2 décimales */}
      </span>
    </div>
  </div>
</div>
              <div style={{ display: 'inline-flex', alignItems: 'center' }}>
                ...
                <div className="progress" style={{ height: '13px', borderRadius: '5px', width: '100px', position: 'relative', flexGrow: 1 }}>
                  <div
                    className={`progress-bar ${getProgressColor12(infos.fcf_margin_five_year)}`}
                    role="progressbar"
            ...
            <div className="col-md-6 col-lg-4 mb-4">
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center' }}>
                ...
                <div className="progress" style={{ height: '13px', borderRadius: '5px', width: '100px', position: 'relative', flexGrow: 1 }}>
                  <div
                    className={`progress-bar ${getProgressColor18(infos.debt_equity)}`}
                    role="progressbar"
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center' }}>
                ...
                <div className="progress" style={{ height: '13px', borderRadius: '5px', width: '100px', position: 'relative', flexGrow: 1 }}>
                  <div
                    className={`progress-bar ${getProgressColor20(infos.ratio_payout)}`}
                    role="progressbar"
            ...
            <div className="col-md-6 col-lg-4 mb-4">
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center' }}>
                ...
                <div className="progress" style={{ height: '13px', borderRadius: '5px', width: '100px', position: 'relative', flexGrow: 1 }}>
                  <div
                    className={`progress-bar ${getProgressColor13(infos.croissance_annualisee)}`}
                    role="progressbar"
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center' }}>
                ...
                <div className="progress" style={{ height: '13px', borderRadius: '5px', width: '100px', position: 'relative', flexGrow: 1 }}>
                  <div
                    className={`progress-bar ${getProgressColor14(infos.croissance_moyenne)}`}
                    role="progressbar"
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center' }}>
                ...
                <div className="progress" style={{ height: '13px', borderRadius: '5px', width: '30px', position: 'relative', flexGrow: 1 }}>
                  <div
                    className={`progress-bar ${getProgressColor15(infos.nbreannee)}`}
                    role="progressbar"
            ...
            <div className="col-md-6 col-lg-4 mb-4">
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center' }}>
                ...
                <div className="progress" style={{ height: '13px', borderRadius: '5px', width: '100px', position: 'relative', flexGrow: 1 }}>
                  <div
                    className={`progress-bar ${getProgressColor19(infos.buyback_yield)}`}
                    role="progressbar"
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center' }}>
                ...
                <div className="progress" style={{ height: '13px', borderRadius: '5px', width: '30px', position: 'relative', flexGrow: 1 }}>
                  <div
                    className={`progress-bar ${getProgressColor21(infos.piotroski_score)}`}
                    role="progressbar"
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center' }}>
                ...
                <div className="progress" style={{ height: '13px', borderRadius: '5px', width: '100px', position: 'relative', flexGrow: 1 }}>
                  <div
                    className={`progress-bar ${getProgressColor16(infos.rachat_net_moyen)}`}
                    role="progressbar"
