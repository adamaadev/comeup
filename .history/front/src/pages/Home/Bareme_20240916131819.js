                ...
                <tbody>
                    <tr>
                        ...
                        <td style={{ padding: '10px', border: '1px solid #ddd' }}>
                            {financialData.excellent.croissance1an}%
                        </td>
                        <td style={{ padding: '10px', border: '1px solid #ddd' }}>
                            {financialData.excellent.croissance5ans}%
                        </td>
                        <td style={{ padding: '10px', border: '1px solid #ddd' }}>
                            {financialData.excellent.croissance10ans}%
                        </td>
                    </tr>
                    <tr>
                        <th style={{ padding: '10px', border: '1px solid #ddd' }}>Correct</th>
                        <td style={{ padding: '10px', border: '1px solid #ddd' }}>
                            {financialData.correct.croissance1an}%
                        </td>
                        <td style={{ padding: '10px', border: '1px solid #ddd' }}>
                            {financialData.correct.croissance5ans}%
                        </td>
                        <td style={{ padding: '10px', border: '1px solid #ddd' }}>
                            {financialData.correct.croissance10ans}%
                        </td>
                    </tr>
                    <tr>
                        <th style={{ padding: '10px', border: '1px solid #ddd' }}>Faible</th>
                        <td style={{ padding: '10px', border: '1px solid #ddd' }}>
                            {financialData.faible.croissance1an}%
                        </td>
                        <td style={{ padding: '10px', border: '1px solid #ddd' }}>
                            {financialData.faible.croissance5ans}%
                        </td>
                        <td style={{ padding: '10px', border: '1px solid #ddd' }}>
                            {financialData.faible.croissance10ans}%
                        </td>
                    </tr>
                </tbody>
            </table>
