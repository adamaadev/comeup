...
export default function Quati({ symbol }) {
  ...
  const formatPercentage = (num) => {
    return Math.min(Math.max(num, 0), 100); // Limite la valeur entre 0 et 100 pour le pourcentage
  };
        ...
        <div className="card-body">
          ...
          <div className="col-md-6 col-lg-4 mb-4">
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center' }}>
                ...
                <div className="progress" style={{ height: '13px', borderRadius: '5px', width: '100px', position: 'relative', flexGrow: 1 }}>
                  <div
                    className={`progress-bar ${getProgressColor(formatNumber(infos.rachat_net_moyen))}`}
                    role="progressbar"
                    style={{ width: `${formatNumber(infos.rachat_net_moyen)}%` }}
                    aria-valuenow={infos.performance}
                    aria-valuemin="0"
                    aria-valuemax="100"
                  >
