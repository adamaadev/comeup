          ...
          <div className="row">
            ...
            <div className="col-md-6 col-lg-4 mb-4">
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center' }}>
                ...
                <div className="progress" style={{ height: '13px', borderRadius: '5px', width: '100px', position: 'relative', flexGrow: 1 }}>
                  <div
                    className={`progress-bar ${getProgressColor2(infos.ratio_capex_revenu_net)}`}
                    role="progressbar"
            ...
            <div className="col-md-6 col-lg-4 mb-4">
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center' }}>
                ...
                <div className="progress" style={{ height: '13px', borderRadius: '5px', width: '100px', position: 'relative', flexGrow: 1 }}>
                  <div
                    className={`progress-bar ${getProgressColor3(infos.roce)}`}
                    role="progressbar"
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center' }}>
                ...
                <div className="progress" style={{ height: '13px', borderRadius: '5px', width: '100px', position: 'relative', flexGrow: 1 }}>
                  <div
                    className={`progress-bar ${getProgressColor4(infos.roce_5_year_avg)}`}
                    role="progressbar"
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center' }}>
                ...
                <div className="progress" style={{ height: '13px', borderRadius: '5px', width: '100px', position: 'relative', flexGrow: 1 }}>
                  <div
                    className={`progress-bar ${getProgressColor5(infos.fcf_margin_one_year)}`}
                    role="progressbar"
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center' }}>
                ...
                <div className="progress" style={{ height: '13px', borderRadius: '5px', width: '100px', position: 'relative', flexGrow: 1 }}>
                  <div
                    className={`progress-bar ${getProgressColor6(infos.fcf_margin_five_year)}`}
                    role="progressbar"
            ...
            <div className="col-md-6 col-lg-4 mb-4">
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center' }}>
                ...
                <div className="progress" style={{ height: '13px', borderRadius: '5px', width: '100px', position: 'relative', flexGrow: 1 }}>
                  <div
                    className={`progress-bar ${getProgressColor7(infos.debt_equity)}`}
                    role="progressbar"
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center' }}>
                ...
                <div className="progress" style={{ height: '13px', borderRadius: '5px', width: '100px', position: 'relative', flexGrow: 1 }}>
                  <div
                    className={`progress-bar ${getProgressColor8(infos.ratio_payout)}`}
                    role="progressbar"
            ...
            <div className="col-md-6 col-lg-4 mb-4">
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center' }}>
                ...
                <div className="progress" style={{ height: '13px', borderRadius: '5px', width: '100px', position: 'relative', flexGrow: 1 }}>
                  <div
                    className={`progress-bar ${getProgressColor9(infos.croissance_annualisee)}`}
                    role="progressbar"
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center' }}>
                ...
                <div className="progress" style={{ height: '13px', borderRadius: '5px', width: '100px', position: 'relative', flexGrow: 1 }}>
                  <div
                    className={`progress-bar ${getProgressColor10(infos.croissance_moyenne)}`}
                    role="progressbar"
