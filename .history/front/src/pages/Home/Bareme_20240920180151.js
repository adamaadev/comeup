    ...
    <div style={{ margin: '20px' }}>
      ...
      <table style={{ borderCollapse: 'collapse', width: '15%' }}>
        <thead className='Bareme'>
          ...
          <tr>
            <td style={tableHeaderStyle}>{'>='}Oui</td>
            <td style={tableHeaderStyle}>+0.5point</td>
          </tr>
          <tr>
            <td style={tableHeaderStyle}>Non</td>
            <td style={tableHeaderStyle}>+0 point</td>
          </tr> <tr>
            <td style={tableHeaderStyle}>Partiellement</td>
            <td style={tableHeaderStyle}>+0.5 point</td>
          </tr>
        </thead>
        <tbody>
        </tbody>
