...
export default function Quati({ symbol }) {
  ...
  {[
    { label: 'ROCE 1 an', value: infos.roce, color: getProgressColor9(infos.roce) },
    { label: 'ROCE 5 ans', value: infos.roce_5_year_avg, color: getProgressColor10(infos.roce_5_year_avg) },
    { label: 'FcF Margin 1 an', value: infos.fcf_margin_one_year, color: getProgressColor11(infos.fcf_margin_one_year) },
    { label: 'FcF Margin 5 ans', value: infos.fcf_margin_five_year, color: getProgressColor12(infos.fcf_margin_five_year) }
  ].map((item, index) => (
