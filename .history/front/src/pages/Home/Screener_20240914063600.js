...
export default function Screener() {
  ...
  useEffect(() => {
    axios.get('http://localhost:4000/screener')
      .then(res => {
        const sortedData = res.data.sort((a, b) => (parseFloat(b.Capitalisation) || 0) - (parseFloat(a.Capitalisation) || 0));
        setInfos(sortedData);
  ...
  useEffect(() => {
    const applyFilters = () => {
      ...
      return filtered.sort((a, b) => (parseFloat(b.Capitalisation) || 0) - (parseFloat(a.Capitalisation) || 0));
    };
