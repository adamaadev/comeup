      ...
      {isSidebarOpen && (
        <aside className={`bg-light border-start p-3 position-fixed top-0 end-0 vh-100 sidebar ${isSidebarOpen ? 'open' : ''}`} style={{ minWidth: '250px', zIndex: '1000' }}>
          ...
          <nav className="d-flex flex-column mt-5">
            ...
            <NavLink to={'/quanti'} style={{ textDecoration: 'none' }} className="mb-3">Bareme Quantitatif</NavLink>
            <NavLink to={'/quali'} style={{ textDecoration: 'none' }} className="mb-3">Bareme Qualitatif</NavLink>
