        ...
        <div className="card-body">
          <div className="row">
            ...
            <div className="col-md-6 col-lg-4 mb-4">
              <h5>Croissance</h5>
              <p>
                Performance 5 ans : <span style={{ display: 'inline-block', width: '20%' }}>
                  <ProgressBar value={infos.performance} />
                </span>
                %
              </p>
              <p>
                Croissance CA 1 an : <span style={{ display: 'inline-block', width: '20%' }}>
                  <ProgressBar value={infos.croissance_CA_1_an} />
                </span>
                %
              </p>
              <p>
                Croissance CA 5 ans : <span style={{ display: 'inline-block', width: '20%' }}>
                  <ProgressBar value={infos.croissance_CA_5_ans} />
                </span>
                %
              </p>
              <p>
                Croissance CA 10 ans : <span style={{ display: 'inline-block', width: '20%' }}>
            ...
            <div className="col-md-6 col-lg-4 mb-4">
              <h5>Profits</h5>
              <p>
                Résultat Net 1 an : <span style={{ display: 'inline-block', width: '20%' }}>
                  <ProgressBar value={infos.croissance_resultat_net_1_an} />
                </span>
                %
              </p>
              <p>
                Résultat Net 5 ans : <span style={{ display: 'inline-block', width: '20%' }}>
            ...
            <div className="col-md-6 col-lg-4 mb-4">
              <h5>Rentabilité</h5>
              <p>
                ROCE 1 an : <span style={{ display: 'inline-block', width: '20%' }}>
                  <ProgressBar value={infos.roce} />
                </span>
                %
              </p>
              <p>
                ROCE 5 ans : <span style={{ display: 'inline-block', width: '20%' }}>
            ...
            <div className="col-md-6 col-lg-4 mb-4">
              <h5>Santé</h5>
              <p>
                Debt to Equity Ratio : <span style={{ display: 'inline-block', width: '20%' }}>
            ...
            <div className="col-md-6 col-lg-4 mb-4">
              <h5>Dividende</h5>
              <p>
                Croissance 1 AN : <span style={{ display: 'inline-block', width: '20%' }}>
                  <ProgressBar value={infos.croissance_annualisee} />
                </span>
                %
              </p>
              <p>
                Le dividende n'a pas diminué depuis : <span style={{ display: 'inline-block', width: '20%' }}>
            ...
            <div className="col-md-6 col-lg-4 mb-4">
              <h5>Autre</h5>
              <p>
                Buyback Yield : <span style={{ display: 'inline-block', width: '20%' }}>
                  <ProgressBar value={infos.buyback_yield} />
                </span>
                %
              </p>
              <p>
                Piotroski Score : <span style={{ display: 'inline-block', width: '20%' }}>
