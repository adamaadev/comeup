...
export default function Region({ symbol }) {
  ...
  const predefinedColors = ['#0088FE', '#00C49F', '#FFBB28', '#FF8042']; // Couleurs pour chaque segmentation
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      try {
        // Récupération des données de segmentation géographique
        ...
        // Récupération des données de segmentation produit
