...
export default function Bareme() {
    ...
    // Grouping data by 'notation'
    const groupedData = {
        Excellente: financialData.filter(item => item.croissance_annualisee_notation === 'Excellente'),
        Correct: financialData.filter(item => item.croissance_annualisee_notation === 'Correct'),
        Faible: financialData.filter(item => item.croissance_annualisee_notation === 'Faible')
    };
