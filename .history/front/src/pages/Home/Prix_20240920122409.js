    ...
    try {
      ...
      switch (range) {
        ...
        case '5y':
          ...
          break;
        case 'YTD':
          startDate.setMonth(0, 1); // Set start date to January 1st
          days = Math.floor((new Date(today) - startDate) / (1000 * 60 * 60 * 24));
          break;
        default:
          days = 365;
      }
      ...
      switch (range) {
        ...
        case '6m':
          ...
          break;
        case '1y':
          data = data.filter((item) => new Date(item.date).getDate() === 1);
          break;
        case '5y':
