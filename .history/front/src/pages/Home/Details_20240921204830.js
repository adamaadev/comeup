...
export default function Details() {
          ...
          <div className="row">
            ...
            <div className="col-lg-4 col-md-12">
              <div className="card p-3">
                ...
                <p>Pays : {infos.pays}</p>
                <p>Isin : {infos.isin}</p>
                <p>Éligible au PEA : {infos.Pea}</p>
                <p>Verse Dividende : {infos.Dividende}</p>
              </div>
            </div>
  ...
  <div
    ...
    style={{
      maxWidth: 'max-content',  // Ajuste la largeur en fonction du contenu
      maxHeight: 'max-content', // Ajuste la hauteur en fonction du contenu
      overflow: 'hidden',       // Supprime le scroll horizontal et vertical
      position: 'relative'
    }}
  >
