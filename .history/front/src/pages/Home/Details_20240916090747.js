...
export default function Details() {
          ...
          <div className="row">
            ...
            <div className="col-lg-4 col-md-12">
              <div className="card p-3">
                ...
                <p>Secteur : {infos.secteur}</p>
                <p>Industrie : {infos.industrie}</p>
                ...
                <p>Pays : {infos.pays}</p>
                <p>Isin : {infos.isin}</p>
                <p>Éligible au PEA : {infos.Pea === 1 ? 'Oui' : 'Non'}</p>
                <p>Verse Dividende : {infos.Dividende === 1 ? 'Oui' : 'Non'}</p>
              </div>
            </div>
  ...
  <div 
    ...
    style={{ 
      maxWidth: '1000px', 
      maxHeight: '1500px', 
      overflow: 'hidden', // Enlève le défilement horizontal et vertical
      position: 'relative', // Position relative pour les éléments internes
      display: 'flex',
      flexDirection: 'column'
    }}
  >
    <div style={{ width: '100%', height: '100%' }}> {/* Assurez-vous que ce contenu remplit toute la carte */}
  ...
  <div 
    ...
    style={{ 
      ...
      display: 'flex',
      flexDirection: 'column',
      width: '100%' // Prend toute la largeur disponible pour être en dessous du premier composant
    }}
  >
    <div style={{ width: '100%', height: '100%' }}> {/* Assurez-vous que ce contenu remplit toute la carte */}
      <Vente symbol={symbol} />
