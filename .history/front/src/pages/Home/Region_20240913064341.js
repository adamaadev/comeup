...
export default function Region({ symbol }) {
  ...
  // Check if geoData or logo is empty
  const shouldShowTitleAndLogo = geoData.length > 0 && logo;

  return (
    <div className="chart-wrapper" style={{ width: '100%', padding: '1rem', position: 'relative' }}>
      {shouldShowTitleAndLogo && <h3>Segmentation Géographique</h3>}
      <div style={{ 
        position: 'relative', 
        width: '100%', 
