...
export default function Quali({ symbol }) {
  ...
  <h4 style={{ display: 'flex', alignItems: 'center', margin: 0 }}>
    Quali-score :
    <div className="progress" style={{ flex: 1, maxWidth: '150px', margin: '10px 0 5px 5px', position: 'relative', height: '20px', backgroundColor: '#d3d3d3', borderRadius: '5px', overflow: 'hidden' }}>
      <div
        ...
        aria-valuemax="20"
      >
        <span style={{ position: 'absolute', color: 'white', textAlign: 'center', width: '100%', fontSize: '12px' }}>
          {score} / 20
        </span>
      </div>
    </div>
