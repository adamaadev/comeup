        ...
        {activeTab === 'Informations' && (
          <div className="row">
            ...
            <div className="d-flex">
              <div className="card mt-1 ml-0 p-3 ms-3" style={{ maxWidth: '1000px', maxHeight: '400px', overflowX: 'auto', overflowY: 'auto' }}>
                <div style={{ minWidth: '1000px' }}> {/* Assurez-vous que ce contenu est plus large que la carte */}
                  <Region symbol={symbol} />
                </div>
              </div>
              <div className="card p-3 ms-3" style={{ maxWidth: '700px', maxHeight: '400px', overflowX: 'auto', overflowY: 'auto' }}>
