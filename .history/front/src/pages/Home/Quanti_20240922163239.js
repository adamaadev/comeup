...
export default function Quati({ symbol }) {
  ...
  const getProgressColor8 =( croissance_resultat_net_5_ans >= 14 )=>{
    if (croissance_resultat_net_1_an >= 12) {
      return 'bg-success';
    } else if (croissance_resultat_net_1_an >= 10 && croissance_resultat_net_1_an < 12) {
      return 'bg-warning';
  ...
  const getProgressColor9 =( croissance_resultat_net_1_an )=>{
    if (croissance_resultat_net_1_an >= 12) {
      return 'bg-success';
    } else if (croissance_resultat_net_1_an >= 10 && croissance_resultat_net_1_an < 12) {
      return 'bg-warning';
  ...
  const getProgressColor10 =( croissance_resultat_net_1_an )=>{
    if (croissance_resultat_net_1_an >= 12) {
      return 'bg-success';
    } else if (croissance_resultat_net_1_an >= 10 && croissance_resultat_net_1_an < 12) {
      return 'bg-warning';
  ...
  const getProgressColor11 =( croissance_resultat_net_1_an )=>{
    if (croissance_resultat_net_1_an >= 12) {
      return 'bg-success';
    } else if (croissance_resultat_net_1_an >= 10 && croissance_resultat_net_1_an < 12) {
      return 'bg-warning';
