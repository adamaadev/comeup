...
export default function Details() {
  ...
  <div className="card p-3 ms-8" style={{ maxWidth: '500px', maxHeight: '400px', overflowX: 'auto', overflowY: 'auto', whiteSpace: 'nowrap' }}>
    <Region symbol={symbol} />
  </div>
  <div className="card p-3 ms-3" style={{ maxWidth: '500px', maxHeight: '400px', overflowX: 'auto', overflowY: 'auto', whiteSpace: 'nowrap' }}>
    <Region symbol={symbol} />
  </div>
</div>
