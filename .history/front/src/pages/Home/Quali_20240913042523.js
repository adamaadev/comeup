  ...
  return (
    <div>
      ...
      <ol>
        ...
        <li>16. Price: {infos.price || 'N/A'}</li>
        <li>17. Rachat net moyen: {infos.rachat_net_moyen || 'N/A'}</li>
        <li>18. Ratio CAPEX Revenu Net: {infos.ratio_capex_revenu_net || 'N/A'}</li>
        <li>19. Ratio Payout: {infos.ratio_payout || 'N/A'}</li>
        <li>20. ROCE: {infos.roce || 'N/A'}</li>
        <li>21. ROCE 5 year average: {infos.roce_5_year_avg || 'N/A'}</li>
        <li>22. Ratio Debt to Equity: {infos.debt_equity || 'N/A'}</li>
        <li>23. Nombre d'années: {infos.nbreannee || 'N/A'}</li>
      </ol>
    </div>
  );
}
