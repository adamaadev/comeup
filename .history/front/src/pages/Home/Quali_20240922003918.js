...
export default function Quali({ symbol }) {
  ...
  return (
    <div className="container mt-4">
      ...
      <div className="card-header" style={{ marginLeft: "10px", width: "98.5%", display: 'flex', justifyContent: 'space-between', alignItems: 'center', backgroundColor: '#f0f0f0', padding: '10px', borderRadius: '5px' }}>
  <h4 style={{ margin: 0 }}>Analyse qualitative</h4>
  <h4 style={{ display: 'flex', alignItems: 'center', margin: 0, marginLeft: '10px' }}>
    Quali-score :
...
<style>
  @media (max-width: 600px) {
    .card-header h4 {
      margin: 10px 0; /* Ajouter un espace vertical entre les titres sur mobile */
    }
  }
</style>
