...
export default function Quati({ symbol }) {
  ...
  const formatNumber = (num) => {
    ...
    if (Math.abs(num) >= 1e9) {
      return (Math.round(num / 1e7) / 100) + ' MDS'; // Arrondir à deux chiffres après la virgule
    } else if (Math.abs(num) >= 1e6) {
      return (Math.round(num / 1e5) / 100) + ' M'; // Arrondir à deux chiffres après la virgule
    } else {
      return num.toFixed(3); // Limiter à deux chiffres après la virgule
    }
  };
          ...
          <div className="row">
            <div className="col-md-6 col-lg-4 mb-4">
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center' }}>
                ...
                <div className="progress" style={{ height: '13px', borderRadius: '5px', width: '100px', position: 'relative', flexGrow: 1 }}>
                  <div
                    className={`progress-bar ${getProgressColor(infos.fcf_5_years)}`}
                    role="progressbar"
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center' }}>
                ...
                <div className="progress" style={{ height: '13px', borderRadius: '5px', width: '100px', position: 'relative', flexGrow: 1 }}>
                  <div
                    className={`progress-bar ${getProgressColor(infos.fcf_10_years)}`}
                    role="progressbar"
            ...
            <div className="col-md-6 col-lg-4 mb-4">
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center' }}>
                ...
                <div className="progress" style={{ height: '13px', borderRadius: '5px', width: '100px', position: 'relative', flexGrow: 1 }}>
                  <div
                    className={`progress-bar ${getProgressColor(infos.croissance_resultat_net_1_an)}`}
                    role="progressbar"
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center' }}>
                ...
                <div className="progress" style={{ height: '13px', borderRadius: '5px', width: '100px', position: 'relative', flexGrow: 1 }}>
                  <div
                    className={`progress-bar ${getProgressColor(infos.croissance_resultat_net_5_ans)}`}
                    role="progressbar"
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center' }}>
                ...
                <div className="progress" style={{ height: '13px', borderRadius: '5px', width: '100px', position: 'relative', flexGrow: 1 }}>
                  <div
                    className={`progress-bar ${getProgressColor(infos.ratio_capex_revenu_net)}`}
                    role="progressbar"
            ...
            <div className="col-md-6 col-lg-4 mb-4">
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center' }}>
                ...
                <div className="progress" style={{ height: '13px', borderRadius: '5px', width: '100px', position: 'relative', flexGrow: 1 }}>
                  <div
                    className={`progress-bar ${getProgressColor(infos.roce)}`}
                    role="progressbar"
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center' }}>
                ...
                <div className="progress" style={{ height: '13px', borderRadius: '5px', width: '100px', position: 'relative', flexGrow: 1 }}>
                  <div
                    className={`progress-bar ${getProgressColor(infos.roce_5_year_avg)}`}
                    role="progressbar"
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center' }}>
                ...
                <div className="progress" style={{ height: '13px', borderRadius: '5px', width: '100px', position: 'relative', flexGrow: 1 }}>
                  <div
                    className={`progress-bar ${getProgressColor(infos.fcf_margin_one_year)}`}
                    role="progressbar"
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center' }}>
                ...
                <div className="progress" style={{ height: '13px', borderRadius: '5px', width: '100px', position: 'relative', flexGrow: 1 }}>
                  <div
                    className={`progress-bar ${getProgressColor(infos.fcf_margin_five_year)}`}
                    role="progressbar"
            ...
            <div className="col-md-6 col-lg-4 mb-4">
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center' }}>
                ...
                <div className="progress" style={{ height: '13px', borderRadius: '5px', width: '100px', position: 'relative', flexGrow: 1 }}>
                  <div
                    className={`progress-bar ${getProgressColor(infos.debt_equity)}`}
                    role="progressbar"
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center' }}>
                ...
                <div className="progress" style={{ height: '13px', borderRadius: '5px', width: '100px', position: 'relative', flexGrow: 1 }}>
                  <div
                    className={`progress-bar ${getProgressColor(infos.ratio_payout)}`}
                    role="progressbar"
            ...
            <div className="col-md-6 col-lg-4 mb-4">
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center' }}>
                ...
                <div className="progress" style={{ height: '13px', borderRadius: '5px', width: '100px', position: 'relative', flexGrow: 1 }}>
                  <div
                    className={`progress-bar ${getProgressColor(infos.croissance_annualisee)}`}
                    role="progressbar"
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center' }}>
                ...
                <div className="progress" style={{ height: '13px', borderRadius: '5px', width: '100px', position: 'relative', flexGrow: 1 }}>
                  <div
                    className={`progress-bar ${getProgressColor(infos.croissance_moyenne)}`}
                    role="progressbar"
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center' }}>
                ...
                <div className="progress" style={{ height: '13px', borderRadius: '5px', width: '100px', position: 'relative', flexGrow: 1 }}>
                  <div
                    className={`progress-bar ${getProgressColor(infos.nbreannee)}`}
                    role="progressbar"
            ...
            <div className="col-md-6 col-lg-4 mb-4">
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center' }}>
                ...
                <div className="progress" style={{ height: '13px', borderRadius: '5px', width: '100px', position: 'relative', flexGrow: 1 }}>
                  <div
                    className={`progress-bar ${getProgressColor(infos.buyback_yield)}`}
                    role="progressbar"
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center' }}>
                ...
                <div className="progress" style={{ height: '13px', borderRadius: '5px', width: '100px', position: 'relative', flexGrow: 1 }}>
                  <div
                    className={`progress-bar ${getProgressColor(infos.piotroski_score)}`}
                    role="progressbar"
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center' }}>
                ...
                <div className="progress" style={{ height: '13px', borderRadius: '5px', width: '100px', position: 'relative', flexGrow: 1 }}>
                  <div
                    className={`progress-bar ${getProgressColor(infos.rachat_net_moyen)}`}
                    role="progressbar"
