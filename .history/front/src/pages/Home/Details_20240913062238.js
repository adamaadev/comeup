      ...
      <div className="tab-content mt-4">
        {activeTab === 'Informations' && (
          <div className="row">
            ...
            <div className="scroll-container" style={{ overflowX: 'auto', overflowY: 'auto', maxWidth: '100%' }}>
  <div className="d-flex">
    <div className="card p-3 flex-fill" style={{ maxWidth: '500px', minWidth: '300px' }}>
      <Region symbol={symbol} />
    </div>
    <div className="card p-3 ms-3 flex-fill" style={{ maxWidth: '500px', minWidth: '300px' }}>
      <Region symbol={symbol} />
    </div>
  </div>
</div>
