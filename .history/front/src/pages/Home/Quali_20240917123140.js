...
export default function Quali({ symbol }) {
  ...
  <div className="row">
    ...
    <div className="col-md-6 col-lg-4 mb-4">
      <h5>Croissance</h5>
      <p>Performance 5 ans : <ProgressBar value={infos.performance} /> %</p>
      <p>Croissance CA 1 an : <ProgressBar value={infos.croissance_CA_1_an} /> %</p>
      <p>Croissance CA 5 ans : <ProgressBar value={infos.croissance_CA_5_ans} /> %</p>
      <p>Croissance CA 10 ans : <ProgressBar value={infos.croissance_CA_10_ans} /> %</p>
    </div>

    {/* Profits */}
    <div className="col-md-6 col-lg-4 mb-4">
      <h5>Profits</h5>
      <p>Résultat Net 1 an : <ProgressBar value={infos.croissance_resultat_net_1_an} /> %</p>
      <p>Résultat Net 5 ans : <ProgressBar value={infos.croissance_resultat_net_5_ans} /> %</p>
    </div>

    {/* Rentabilité */}
    <div className="col-md-6 col-lg-4 mb-4">
      <h5>Rentabilité</h5>
      <p>ROCE 1 an : <ProgressBar value={infos.roce} /> %</p>
      <p>ROCE 5 ans : <ProgressBar value={infos.roce_5_year_avg} /> %</p>
    </div>

    {/* Santé */}
    <div className="col-md-6 col-lg-4 mb-4">
      <h5>Santé</h5>
      <p>Debt to Equity Ratio : <ProgressBar value={infos.debt_equity} /></p>
    </div>

    {/* Dividende */}
    <div className="col-md-6 col-lg-4 mb-4">
      <h5>Dividende</h5>
      <p>Croissance 1 AN : <ProgressBar value={infos.croissance_annualisee} /> %</p>
      <p>Le dividende n'a pas diminué depuis : <ProgressBar value={infos.nbreannee} /> an(s)</p>
    </div>

    {/* Autre */}
    <div className="col-md-6 col-lg-4 mb-4">
      <h5>Autre</h5>
      <p>Buyback Yield : <ProgressBar value={infos.buyback_yield} /> %</p>
      <p>Piotroski Score : <ProgressBar value={infos.piotroski_score} /> / 9 points</p>
    </div>
  </div>
</div>
