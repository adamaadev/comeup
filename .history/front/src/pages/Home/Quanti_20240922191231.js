          ...
          <div className="row">
            ...
            <div className="col-md-6 col-lg-4 mb-4">
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center' }}>
                ...
                <div className="progress" style={{ height: '13px', borderRadius: '5px', width: '100px', position: 'relative', flexGrow: 1 }}>
                  <div
                    className={`progress-bar ${getProgressColor8(infos.roce)}`}
                    role="progressbar"
            ...
            <div className="col-md-6 col-lg-4 mb-4">
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center' }}>
                ...
                <div className="progress" style={{ height: '13px', borderRadius: '5px', width: '100px', position: 'relative', flexGrow: 1 }}>
                  <div
                    className={`progress-bar ${getProgressColor9(infos.debt_equity)}`}
                    role="progressbar"
            ...
            <div className="col-md-6 col-lg-4 mb-4">
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center' }}>
                ...
                <div className="progress" style={{ height: '13px', borderRadius: '5px', width: '100px', position: 'relative', flexGrow: 1 }}>
                  <div
                    className={`progress-bar ${getProgressColor10(infos.croissance_annualisee)}`}
                    role="progressbar"
            ...
            <div className="col-md-6 col-lg-4 mb-4">
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center' }}>
                ...
                <div className="progress" style={{ height: '13px', borderRadius: '5px', width: '100px', position: 'relative', flexGrow: 1 }}>
                  <div
                    className={`progress-bar ${getProgressColor11(infos.buyback_yield)}`}
                    role="progressbar"
