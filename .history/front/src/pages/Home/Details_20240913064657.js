...
export default function Details() {
  ...
  <div 
    ...
    style={{ 
      maxWidth: '1000px', 
      maxHeight: '400px', 
      overflowX: 'hidden', // Enlève le défilement horizontal
      overflowY: 'auto', // Ajoute un défilement vertical si nécessaire
      position: 'relative' // Position relative pour les éléments internes
    }}
  >
    <div style={{ minWidth: '1000px', minHeight: '400px' }}> {/* Assurez-vous que ce contenu est plus large que la carte */}
  ...
  >
    <div style={{ minWidth: '900px', minHeight: '400px' }}> {/* Assurez-vous que ce contenu est plus large que la carte */}
      <Region symbol={symbol} />
    </div>
  </div>
</div>
