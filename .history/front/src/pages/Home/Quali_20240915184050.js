    ...
    <div className="row">
      ...
      <div className="col-md-6 mb-4">
        <div className="card">
          ...
          <div className="card-body">
            ...
            <p>Croissance CA 1 an : {infos.croissance_CA_5_ans}%</p>
      ...
      <div className="col-md-6 mb-4">
        <div className="card">
          ...
          <div className="card-body">
            <p>Croissance Annualisée du Dividende : {infos.croissance_CA_1_an} %</p>
            <p>Croissance moyenne du dividende sur 5 ans : {infos.croissance_CA_5_ans} %</p>
