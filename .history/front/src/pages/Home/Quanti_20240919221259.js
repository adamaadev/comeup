...
export default function Quati({ symbol }) {
  ...
  useEffect(() => {
    axios.post("http://localhost:4000/screener/ratios", { symbol })
      .then((res) => {
        ...
        setInfos(data);
        // Calcul du score basé sur la performance et autres critères (si nécessaire)
  ...
  // Fonction pour calculer le score en fonction de la performance (ou autres ratios)
