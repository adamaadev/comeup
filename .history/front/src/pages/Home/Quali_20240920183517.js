...
export default function Quali({ symbol }) {
  ...
  Quali-score : 
  <div className="progress" style={{ width: '100%', margin: '0 10px', position: 'relative' }}>
    <div
      ...
      aria-valuemax="20"
    >
      <span style={{ position: 'absolute', right: 0, left: 0, color: 'white', textAlign: 'center', width: '100%' }}>
        {score} / 20
      </span>
    </div>
  </div>
