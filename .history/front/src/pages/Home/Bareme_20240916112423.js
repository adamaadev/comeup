...
export default function Bareme () {
    ...
    <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left' }}>
        <thead>
            <tr>
                <th rowSpan="3" style={{ border: '2px solid #ddd', padding: '10px' }}>Catégorie</th>
                
                <th colSpan="2" style={{ border: '2px solid #ddd', padding: '10px', textAlign: 'center' }}></th>
                ...
                <th colSpan="4" style={{ border: '2px solid #ddd', padding: '10px', textAlign: 'center' }}>Autres</th>
            </tr>
            <tr>
                <th colSpan={2} style={{ border: '2px solid #ddd', padding: '10px' }}>Ratio 2</th>
