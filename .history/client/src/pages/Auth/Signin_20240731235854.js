    ...
    <div className="body-background">
      <div className="form-container">
        ...
        <form onSubmit={submit}>
          ...
          <div className="links">
            <Link to={'/signup'} className="d-inline">S'inscrire</Link>
            <Link to={'/forget'} className="d-inline">Mot de passe oublié ?</Link>
          </div>
          <div className="btn-group">
            <button type="submit" className="btn btn-primary">Connexion</button>
            <button type="button" className="btn btn-secondary">Connexion avec Google</button>
          </div>
        </form>
      </div>
    </div>
