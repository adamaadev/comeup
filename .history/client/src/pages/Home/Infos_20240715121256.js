 ...
 useEffect(() => {
  ...
  return (
    <div>   
      ...
      <p>
        Croissance CA 1 an ({dateOneYearAgo} à {dateLastYear}) : {croissanceCA1an.toFixed(2)}%
      </p>
      <p>
        Croissance CA 5 ans ({dateFiveYearsAgo} à {dateLastYear}) : {croissanceCA5ans.toFixed(2)}%
      </p>
      <p>
        Croissance CA 10 ans ({dateTenYearsAgo} à {dateLastYear}) : {croissanceCA10ans.toFixed(2)}%
      </p>
    </div>
  )
}