 ...
 useEffect(() => {
  ...
  return (
    <div>   
      ...
      <p>Croissance CA 1 an : {croissanceCA1an.toFixed(2)}%</p>
      <p>Croissance CA 5 ans : {croissanceCA5ans.toFixed(2)}%</p>
      <p>Croissance CA 10 ans : {croissanceCA10ans.toFixed(2)}%</p>
    </div>
  )
}