      ...
      <div className="row">
        ...
        <div className="col-md-6 mb-4">
          <div className="card">
            ...
            <div className="card-body">
              ...
              <p>FCF 5 ans : {cagr5Years2}%</p>
              <p>FCF 10 ans : {cagr10Years3}%</p>
            </div>
          </div>
        </div>
        ...
        <div className="col-md-6 mb-4">
          <div className="card">
            ...
            <div className="card-body">
              {netIncomeGrowthOneYear && <p>Résultat Net 1 an : {netIncomeGrowthOneYear}%</p>}
              {netIncomeGrowthFiveYears && <p>Résultat Net 5 ans : {netIncomeGrowthFiveYears}%</p>}
              {averageRatio && <p>% CAPEX / Résultat Net (moyenne 5 ans) : {averageRatio}%</p>}
            </div>
          </div>
        </div>
        ...
        <div className="col-md-6 mb-4">
          <div className="card">
            ...
            <div className="card-body">
              {roce23 && <p>ROCE 1 an : {roce23} %</p>}
              <p>ROCE 5 ans : {pct1} %</p>
              {fcfMarginOneYear && <p>Free Cash Flow Margin 1 an : {fcfMarginOneYear}%</p>}
              {averageMarginFiveYears && <p>Free Cash Flow Margin 5 ans : {averageMarginFiveYears}%</p>}
            </div>
          </div>
        </div>
        ...
        <div className="col-md-6 mb-4">
          <div className="card">
            ...
            <div className="card-body">
              {debtToEquityRatio && <p>Debt to Equity Ratio : {debtToEquityRatio}</p>}
              {payoutRatio && <p>Payout Ratio de {symbol} : {payoutRatio}% </p>}
            </div>
          </div>
        </div>
        ...
        <div className="col-md-6 mb-4">
          <div className="card">
            ...
            <div className="card-body">
              {annualizedGrowthRate && <p>Croissance Annualisée du Dividende : {annualizedGrowthRate}%</p>}
              {growthRate && <p>Croissance moyenne du dividende sur 5 ans : {growthRate}%</p>}
              {currentStreak && <p>Le dividende n'a pas diminué depuis {currentStreak} an(s)</p>}
            </div>
          </div>
        </div>
        ...
        <div className="col-md-6 mb-4">
          <div className="card">
            ...
            <div className="card-body">
              <p>Buyback Yield : {buybackYield}</p>
              <p>Total Piotroski Score : {totalScore} / 9 points</p>
              <p>Rachat net moyen d'actions (moyenne 5 ans) : {netSharesRepurchases}</p>
            </div>
          </div>
        </div>
      </div>
