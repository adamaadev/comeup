...
{isNaN(pct1) || !isFinite(pct1) || pct1 === null ? '' : 
    <div>
        <div className="progress">
            <div className={getProgressClass(pct1)} role="progressbar" style={{ width: `${pct1}%` }} aria-valuenow={pct1} aria-valuemin="0" aria-valuemax="100">
                Roce 5 ans : {pct1} %
            </div>
        </div>
    </div>
    ...
    <div>
        <div className="progress">
            <div className={getProgressClass(cagr5Years)} role="progressbar" style={{ width: `${cagr5Years}%` }} aria-valuenow={cagr5Years} aria-valuemin="0" aria-valuemax="100">
                Performance moyenne sur les 5 dernières années : {cagr5Years}%
            </div>
        </div>
    </div>
}
    ...
    <div>
        <div className="progress">
            <div className={getProgressClass(payoutRatio)} role="progressbar" style={{ width: `${payoutRatio}%` }} aria-valuenow={payoutRatio} aria-valuemin="0" aria-valuemax="100">
                Payout Ratio de {symbol} : {payoutRatio}%
            </div>
        </div>
    </div>
}
    ...
    <div>
        <div className="progress">
            <div className={getProgressClass(fcfMarginOneYear)} role="progressbar" style={{ width: `${fcfMarginOneYear}%` }} aria-valuenow={fcfMarginOneYear} aria-valuemin="0" aria-valuemax="100">
                Free Cash Flow Margin 1 an : {fcfMarginOneYear}%
            </div>
        </div>
    </div>
}
    ...
    <div>
        <div className="progress">
            <div className={getProgressClass(averageMarginFiveYears)} role="progressbar" style={{ width: `${averageMarginFiveYears}%` }} aria-valuenow={averageMarginFiveYears} aria-valuemin="0" aria-valuemax="100">
                Free Cash Flow Margin 5 ans : {averageMarginFiveYears}%
            </div>
        </div>
    </div>
}
    ...
    <div>
        <div className="progress">
            <div className={getProgressClass(annualizedGrowthRate)} role="progressbar" style={{ width: `${annualizedGrowthRate}%` }} aria-valuenow={annualizedGrowthRate} aria-valuemin="0" aria-valuemax="100">
                Croissance Annualisée du Dividende : {annualizedGrowthRate}%
            </div>
        </div>
    </div>
}
    ...
    <div>
        <div className="progress">
            <div className={getProgressClass(netIncomeGrowthOneYear)} role="progressbar" style={{ width: `${netIncomeGrowthOneYear}%` }} aria-valuenow={netIncomeGrowthOneYear} aria-valuemin="0" aria-valuemax="100">
                Croissance du résultat net sur 1 an: {netIncomeGrowthOneYear}%
            </div>
        </div>
    </div>
}
    ...
    <div>
        <div className="progress">
            <div className={getProgressClass(netIncomeGrowthFiveYears)} role="progressbar" style={{ width: `${netIncomeGrowthFiveYears}%` }} aria-valuenow={netIncomeGrowthFiveYears} aria-valuemin="0" aria-valuemax="100">
                Croissance du résultat net sur 5 ans: {netIncomeGrowthFiveYears}%
            </div>
        </div>
    </div>
}
    ...
    <div>
        <div className="progress">
            <div className={getProgressClass(averageRatio)} role="progressbar" style={{ width: `${averageRatio}%` }} aria-valuenow={averageRatio} aria-valuemin="0" aria-valuemax="100">
                Capex / Résultat net (moyenne 5 ans) : {averageRatio}%
            </div>
        </div>
    </div>
}
    ...
    <div>
        <div className="progress">
            <div className={getProgressClass(debtToEquityRatio)} role="progressbar" style={{ width: `${debtToEquityRatio}%` }} aria-valuenow={debtToEquityRatio} aria-valuemin="0" aria-valuemax="100">
                Debt to Equity Ratio de : {debtToEquityRatio}
            </div>
        </div>
    </div>
}
    ...
    <div>
        <div className="progress">
            <div className={getProgressClass(netSharesRepurchases)} role="progressbar" style={{ width: `${netSharesRepurchases}%` }} aria-valuenow={netSharesRepurchases} aria-valuemin="0" aria-valuemax="100">
                Rachat net moyen d'actions (moyenne 5 ans) {symbol}: {netSharesRepurchases}
            </div>
        </div>
    </div>
}
    ...
    <div>
        <div className="progress">
            <div className={getProgressClass(growthRate)} role="progressbar" style={{ width: `${growthRate}%` }} aria-valuenow={growthRate} aria-valuemin="0" aria-valuemax="100">
                Croissance moyenne du dividende sur 5 ans {symbol}: {growthRate} %
            </div>
        </div>
    </div>
}
...
{isNaN(currentStreak) || !isFinite(currentStreak) || currentStreak === null ? '' : 
    <div>
        <div className="progress">
            <div className={getProgressClass(currentStreak)} role="progressbar" style={{ width: `${currentStreak}%` }} aria-valuenow={currentStreak} aria-valuemin="0" aria-valuemax="100">
                Le dividende n'a pas diminué depuis {currentStreak} an(s)
            </div>
        </div>
    </div>
}
...
{isNaN(cagr5Years2) || !isFinite(cagr5Years2) || cagr5Years2 === null ? '' : 
    <div>
        <div className="progress">
            <div className={getProgressClass(cagr5Years2)} role="progressbar" style={{ width: `${cagr5Years2}%` }} aria-valuenow={cagr5Years2} aria-valuemin="0" aria-valuemax="100">
                FCF sur 5 ans : {`${cagr5Years2}%`}
            </div>
        </div>
    </div>
}
...
{isNaN(cagr10Years3) || !isFinite(cagr10Years3) || cagr10Years3 === null ? '' : 
    <div>
        <div className="progress">
            <div className={getProgressClass(cagr10Years3)} role="progressbar" style={{ width: `${cagr10Years3}%` }} aria-valuenow={cagr10Years3} aria-valuemin="0" aria-valuemax="100">
                FCF sur 10 ans : {`${cagr10Years3}%`}
            </div>
        </div>
    </div>
}
...
{isNaN(croissanceCA1an) || !isFinite(croissanceCA1an) || croissanceCA1an === null ? '' : 
    <div>
        <div className="progress">
            <div className={getProgressClass(croissanceCA1an)} role="progressbar" style={{ width: `${croissanceCA1an}%` }} aria-valuenow={croissanceCA1an} aria-valuemin="0" aria-valuemax="100">
                Croissance CA 1 an : {croissanceCA1an}%
            </div>
        </div>
    </div>
}
...
{isNaN(croissanceCA5ans) || !isFinite(croissanceCA5ans) || croissanceCA5ans === null ? '' : 
    <div>
        <div className="progress">
            <div className={getProgressClass(croissanceCA5ans)} role="progressbar" style={{ width: `${croissanceCA5ans}%` }} aria-valuenow={croissanceCA5ans} aria-valuemin="0" aria-valuemax="100">
                Croissance CA 5 ans : {croissanceCA5ans}%
            </div>
        </div>
    </div>
}
...
{isNaN(croissanceCA10ans) || !isFinite(croissanceCA10ans) || croissanceCA10ans === null ? '' : 
    <div>
        <div className="progress">
            <div className={getProgressClass(croissanceCA10ans)} role="progressbar" style={{ width: `${croissanceCA10ans}%` }} aria-valuenow={croissanceCA10ans} aria-valuemin="0" aria-valuemax="100">
                Croissance CA 10 ans : {croissanceCA10ans}%
            </div>
        </div>
    </div>
}
