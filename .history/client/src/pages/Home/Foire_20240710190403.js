...
export default function Foire() {
    ...
    const handleSubmit = (event) => {
        ...
        // Logique de soumission de la réponse (à implémenter selon votre besoin)
        console.log("Réponse soumise :", selectedResponse);
        console.log("Justification :", justification);

        // Exemple : Réinitialisation des états après soumission
        axios.post('http://localhost:4000/sendquestion', { symbol, id })
        .then(response => {
            setSelectedResponse("");
            setJustification("");
            setModalQuestion(null);
