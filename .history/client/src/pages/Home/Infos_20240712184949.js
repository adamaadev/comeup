...
<div>
  ...
  <p>Payout Ratio de {symbol} : {payoutRatio.toFixed(2)} %</p>
  <p>Free Cash Flow Margin pour {symbol}</p>

  {fcfMarginOneYear !== null && (
    <p>Free Cash Flow Margin 1 an : {fcfMarginOneYear.toFixed(2)} %</p>
  )}
  <p>Free Cash Flow Margin 5 ans : {averageMarginFiveYears.toFixed(2)} %</p>
  <p>Croissance Annualisée du Dividende : {annualizedGrowthRate.toFixed(2)} %</p>
  <p>Croissance du résultat net sur 1 an: {netIncomeGrowthOneYear.toFixed(2)} %</p>
  <p>Croissance du résultat net sur 5 ans: {netIncomeGrowthFiveYears.toFixed(2)} %</p>
  <p>Croissance du résultat net sur 10 ans: {netIncomeGrowthTenYears.toFixed(2)} %</p>
  <p>Capex / Résultat net (moyenne 5 ans) : {averageRatio.toFixed(2)} %</p>
  <p>Debt to Equity Ratio de : {debtToEquityRatio.toFixed(2)}</p>
  <p>Rachat net moyen d'actions (moyenne 5 ans) {symbol}: {netSharesRepurchases.toFixed(2)}</p>
