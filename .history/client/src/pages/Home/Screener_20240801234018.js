...
export default function Screener() {
  ...
  const handleError = (e, companySymbol) => {
    e.target.src = 'https://logo.clearbit.com/';
    e.target.alt = 'Logo indisponible';

    axios.post('http://localhost:4000/deleteindexsymbol', { symbol: companySymbol })
      .catch(error => console.error('Error deleting company symbol:', error));
  };
              ...
              <tr key={company.symbol} onClick={() => window.open(`/details/${company.symbol}`, '_blank')}>
                ...
                <td className="d-flex align-items-center">
                  <img
                    ...
                    width="50"
                    height="50"
                    onError={(e) => handleError(e, company.symbol)}
