...
export default function Screener() {
  ...
  // Liste des fournisseurs de logos sans clé API
  const logoProviders = [
    (symbol) => `https://financialmodelingprep.com/api/v3/logo/${symbol}`,
    (symbol) => `https://logo-fetcher.com/api/v1/logos/${symbol}`,
    (symbol) => `https://logo.lynx.io/${symbol}`,
    (symbol) => `https://www.logos-download.com/logos/${symbol}.png`
  ];
