...
export default function Screener() {
  ...
  const fetchRandomCompanies = () => {
    axios.get(`http://localhost:4000/listcompany?page=${page}&limit=10000`)
      .then(res => {
              ...
              <tr key={company.symbol} onClick={() => window.open(`/details/${company.symbol}`, '_blank')}>
                ...
                <td className="d-flex align-items-center">
                  <img
                    ...
                    height="50"
                    onError={()=>{
                      const symbolindex = company.symbol;
                      axios.post('http://localhost:4000/deleteindexsymbol',{symbolindex})
                    }}
