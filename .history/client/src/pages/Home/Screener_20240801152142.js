...
export default function Screener() {
  ...
  const handleError = async (e, symbol) => {
    const fallbackLogo = await getLogoUrl(symbol); // Obtient le logo depuis Financial Modeling Prep

    // Met à jour l'état pour le logo de secours
    e.target.src = fallbackLogo;
    e.target.onerror = null; // Empêche la gestion des erreurs supplémentaires pour cette image
  };
