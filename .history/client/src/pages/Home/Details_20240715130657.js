      ...
      case 'profile':
        return (
          ...
          <div key={index}>
            ...
            <p><strong>Ticker : </strong> {info.symbol}</p>
            <p><strong>Secteur & Industrie: </strong>{info.sector} {info.industry}</p>
            <p><strong>Site web : </strong> {info.website === '' ? '' : <a href={info.website}>{info.website}</a>}</p>
            <p><strong>Capitalisation: </strong> {info.mktCap}</p>
            <p><strong>Prix : </strong> {info.price} {info.currency}</p>
