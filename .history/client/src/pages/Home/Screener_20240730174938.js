...
export default function Screener() {
  ...
  const handleImageError = (e, companyWebsite) => {
    e.target.src = `https://logo.clearbit.com/${companyWebsite}`;
                ...
                <td>
                  <div className="text-center">
                    <img
                      ...
                      onError={(e) => handleImageError(e, company.website)}
                    />
                  </div>
                </td>
                <td className="text-center">{company.companyName}</td>
                <td className="text-center">{company.symbol}</td>
