...
export default function Details() {
  ...
  useEffect(() => {
    axios.get(`https://financialmodelingprep.com/api/v3/information/${symbol}?apikey=7DpR3qkhqfZy2qfQDZZwHrz0Ohd6oRUX`)
      .then(res => {
        setInfos([res.data[0]]) 
        ...
        <div className="card-body">
          <ul className="nav nav-tabs">
            <li className="nav-item">
              <button className={`nav-link ${activeTab === 'information' ? 'active' : ''}`} onClick={() => setActiveTab('information')}>Informations</button>
            </li>
            <li className="nav-item">
