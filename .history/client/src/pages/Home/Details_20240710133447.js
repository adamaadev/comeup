...
export default function Details() {
  ...
  const handleSubmit = () => {
    ...
    console.log("Question:", modalQuestion);
    console.log("Réponse:", selectedResponse);
    console.log("Justification:", justification);
  
    // Ajoutez ici le code pour soumettre les données si nécessaire
  };
  
  // Reste du code pour le modal et le formulaire
  <div className="modal" tabIndex="-1" role="dialog" style={{ display: 'block' }}>
    <div className="modal-dialog" role="document">
      <div className="modal-content">
        <div className="modal-header">
          <h5 className="modal-title">Répondre à la question : {modalQuestion}</h5>
