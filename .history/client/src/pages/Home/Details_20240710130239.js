...
export default function Details() {
  ...
  useEffect(() => {
    axios.get(`https://financialmodelingprep.com/api/v3/informations/${symbol}?apikey=7DpR3qkhqfZy2qfQDZZwHrz0Ohd6oRUX`)
      .then(res => {
        setInfos([res.data[0]]) 
                    ...
                    <div className="modal-body">
                      ...
                      <form>
                        <div className="form-group">
                          ...
                          <select className="form-control" id="response">
                        ...
                        <div className="form-group">
                          ...
                          <textarea className="form-control" id="justification" rows="3"></textarea>
                        </div>
                      </form>
                    </div>
        ...
        <div className="card-body">
          <ul className="nav nav-tabs">
            <li className="nav-item">
              <button className={`nav-link ${activeTab === 'informations' ? 'active' : ''}`} onClick={() => setActiveTab('informations')}>Informations</button>
            </li>
            <li className="nav-item">
              <button className={`nav-link ${activeTab === 'analyse' ? 'active' : ''}`} onClick={() => setActiveTab('analyse')}>Analyse</button>
            </li>
            <li className="nav-item">
              <button className={`nav-link ${activeTab === 'statistiques' ? 'active' : ''}`} onClick={() => setActiveTab('statistiques')}>Statistiques</button>
            </li>
          </ul>
          <div className="mt-3">
            {renderTabContent()}
