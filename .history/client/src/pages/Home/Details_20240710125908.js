      ...
      case 'news':
        return (
          <div>
            ...
            <div className="mt-4">
              <h4>Questions sur les produits</h4>
              <ul>
              ...
              <h4 className="mt-4">Questions sur le positionnement</h4>
              <ul>
              ...
              <h4 className="mt-4">Questions sur le management</h4>
              <ul>
                ...
                <div className="modal-dialog" role="document">
                  <div className="modal-content">
                    ...
                    <div className="modal-footer">
                      <button type="button" className="btn btn-primary" onClick={handleModalClose}>Enregistrer</button>
  ...
  return (
    <div className="container mt-5">
      ...
      <ul className="nav nav-tabs">
        ...
        <li className="nav-item">
          <button className={`nav-link ${activeTab === 'financials' ? 'active' : ''}`} onClick={() => setActiveTab('financials')}>
            Données financières
          </button>
        </li>
        <li className="nav-item">
