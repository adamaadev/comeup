...
const totalScore = netIncomeCount + operatingCashFlowCount + roaCount + cptnetoperating + cptcurrentratio + cptlongtermdebttotalasset + cptsharesoutstanding + cptmargebrute;
 ...
 useEffect(() => {
  ...
  return (
    <div>   
      <p>Score : {score}</p>
      {isNaN(buyback) || !isFinite(buyback) || buyback === null ? '' :
                <div>
                    <div className="progress">
                        <div className={getProgressClass(buyback)} role="progressbar" style={{ width: `${buyback}%` }} aria-valuenow={buyback} aria-valuemin="0" aria-valuemax="100">
                          
                        </div>
                    <p>Buyback yield 1 an : {buyback} %</p>
    ...
    <div>
        <div className="progress">
            <div className={getProgressClass(roce23)} role="progressbar" style={{ width: `${roce23}%` }} aria-valuenow={roce23} aria-valuemin="0" aria-valuemax="100"></div>
        </div>
...
{isNaN(pct1) || !isFinite(pct1) || pct1 === null ? '' : 
    <div>
        <div className="progress">
            <div className={getProgressClass(pct1)} role="progressbar" style={{ width: `${pct1}%` }} aria-valuenow={pct1} aria-valuemin="0" aria-valuemax="100"></div>
        </div>
        <p>Roce 5 ans : {pct1} %</p>
    </div>
}
...
{isNaN(cagr5Years) || !isFinite(cagr5Years) || cagr5Years === null ? '' : 
    <div>
        <div className="progress">
            <div className={getProgressClass(cagr5Years)} role="progressbar" style={{ width: `${cagr5Years}%` }} aria-valuenow={cagr5Years} aria-valuemin="0" aria-valuemax="100"></div>
        </div>
        <p>Performance moyenne sur les 5 dernières années : {cagr5Years}%</p>
    </div>
}
...
{isNaN(payoutRatio) || !isFinite(payoutRatio) || payoutRatio === null ? '' : 
    <div>
        <div className="progress">
            <div className={getProgressClass(payoutRatio)} role="progressbar" style={{ width: `${payoutRatio}%` }} aria-valuenow={payoutRatio} aria-valuemin="0" aria-valuemax="100"></div>
        </div>
...
{isNaN(fcfMarginOneYear) || !isFinite(fcfMarginOneYear) || fcfMarginOneYear === null ? '' : 
    <div>
        <div className="progress">
            <div className={getProgressClass(fcfMarginOneYear)} role="progressbar" style={{ width: `${fcfMarginOneYear}%` }} aria-valuenow={fcfMarginOneYear} aria-valuemin="0" aria-valuemax="100"></div>
        </div>
...
{isNaN(averageMarginFiveYears) || !isFinite(averageMarginFiveYears) || averageMarginFiveYears === null ? '' : 
    <div>
        <div className="progress">
            <div className={getProgressClass(averageMarginFiveYears)} role="progressbar" style={{ width: `${averageMarginFiveYears}%` }} aria-valuenow={averageMarginFiveYears} aria-valuemin="0" aria-valuemax="100"></div>
        </div>
...
{isNaN(annualizedGrowthRate) || !isFinite(annualizedGrowthRate) || annualizedGrowthRate === null ? '' : 
    <div>
        <div className="progress">
            <div className={getProgressClass(annualizedGrowthRate)} role="progressbar" style={{ width: `${annualizedGrowthRate}%` }} aria-valuenow={annualizedGrowthRate} aria-valuemin="0" aria-valuemax="100"></div>
        </div>
...
{isNaN(netIncomeGrowthOneYear) || !isFinite(netIncomeGrowthOneYear) || netIncomeGrowthOneYear === null ? '' : 
    <div>
        <div className="progress">
            <div className={getProgressClass(netIncomeGrowthOneYear)} role="progressbar" style={{ width: `${netIncomeGrowthOneYear}%` }} aria-valuenow={netIncomeGrowthOneYear} aria-valuemin="0" aria-valuemax="100"></div>
        </div>
...
{isNaN(netIncomeGrowthFiveYears) || !isFinite(netIncomeGrowthFiveYears) || netIncomeGrowthFiveYears === null ? '' : 
    <div>
        <div className="progress">
            <div className={getProgressClass(netIncomeGrowthFiveYears)} role="progressbar" style={{ width: `${netIncomeGrowthFiveYears}%` }} aria-valuenow={netIncomeGrowthFiveYears} aria-valuemin="0" aria-valuemax="100"></div>
        </div>
...
{isNaN(averageRatio) || !isFinite(averageRatio) || averageRatio === null ? '' : 
    <div>
        <div className="progress">
            <div className={getProgressClass(averageRatio)} role="progressbar" style={{ width: `${averageRatio}%` }} aria-valuenow={averageRatio} aria-valuemin="0" aria-valuemax="100"></div>
        </div>
...
{isNaN(debtToEquityRatio) || !isFinite(debtToEquityRatio) || debtToEquityRatio === null ? '' : 
    <div>
        <div className="progress">
            <div className={getProgressClass(debtToEquityRatio)} role="progressbar" style={{ width: `${debtToEquityRatio}%` }} aria-valuenow={debtToEquityRatio} aria-valuemin="0" aria-valuemax="100"></div>
        </div>
...
{isNaN(netSharesRepurchases) || !isFinite(netSharesRepurchases) || netSharesRepurchases === null ? '' : 
    <div>
        <div className="progress">
            <div className={getProgressClass(netSharesRepurchases)} role="progressbar" style={{ width: `${netSharesRepurchases}%` }} aria-valuenow={netSharesRepurchases} aria-valuemin="0" aria-valuemax="100"></div>
        </div>
...
{isNaN(growthRate) || !isFinite(growthRate) || growthRate === null ? '' : 
    <div>
        <div className="progress">
            <div className={getProgressClass(growthRate)} role="progressbar" style={{ width: `${growthRate}%` }} aria-valuenow={growthRate} aria-valuemin="0" aria-valuemax="100"></div>
        </div>
        <p>Croissance moyenne du dividende sur 5 ans {symbol}: {growthRate} %</p>
    </div>
}

{isNaN(currentStreak) || !isFinite(currentStreak) || currentStreak === null ? '' : 
    <div>
        <div className="progress">
            <div className={getProgressClass(currentStreak)} role="progressbar" style={{ width: `${currentStreak}%` }} aria-valuenow={currentStreak} aria-valuemin="0" aria-valuemax="100"></div>
        </div>
...
{isNaN(cagr1Year1) || !isFinite(cagr1Year1) || cagr1Year1 === null ? '' : 
    <div>
        <div className="progress">
            <div className={getProgressClass(cagr1Year1)} role="progressbar" style={{ width: `${cagr1Year1}%` }} aria-valuenow={cagr1Year1} aria-valuemin="0" aria-valuemax="100"></div>
        </div>
        <p>FCF 1 an : {`${cagr1Year1}%`}</p>
    </div>
}

{isNaN(cagr5Years2) || !isFinite(cagr5Years2) || cagr5Years2 === null ? '' : 
    <div>
        <div className="progress">
            <div className={getProgressClass(cagr5Years2)} role="progressbar" style={{ width: `${cagr5Years2}%` }} aria-valuenow={cagr5Years2} aria-valuemin="0" aria-valuemax="100"></div>
        </div>
        <p>FCF sur 5 ans : {`${cagr5Years2}%`}</p>
    </div>
}

{isNaN(cagr10Years3) || !isFinite(cagr10Years3) || cagr10Years3 === null ? '' : 
    <div>
        <div className="progress">
            <div className={getProgressClass(cagr10Years3)} role="progressbar" style={{ width: `${cagr10Years3}%` }} aria-valuenow={cagr10Years3} aria-valuemin="0" aria-valuemax="100"></div>
        </div>
        <p>FCF sur 10 ans : {`${cagr10Years3}%`}</p>
    </div>
}

{isNaN(croissanceCA1an) || !isFinite(croissanceCA1an) || croissanceCA1an === null ? '' : 
    <div>
        <div className="progress">
            <div className={getProgressClass(croissanceCA1an)} role="progressbar" style={{ width: `${croissanceCA1an}%` }} aria-valuenow={croissanceCA1an} aria-valuemin="0" aria-valuemax="100"></div>
        </div>
        <p>Croissance CA 1 an : {croissanceCA1an}%</p>
    </div>
}

{isNaN(croissanceCA5ans) || !isFinite(croissanceCA5ans) || croissanceCA5ans === null ? '' : 
    <div>
        <div className="progress">
            <div className={getProgressClass(croissanceCA5ans)} role="progressbar" style={{ width: `${croissanceCA5ans}%` }} aria-valuenow={croissanceCA5ans} aria-valuemin="0" aria-valuemax="100"></div>
        </div>
        <p>Croissance CA 5 ans : {croissanceCA5ans}%</p>
    </div>
}

{isNaN(croissanceCA10ans) || !isFinite(croissanceCA10ans) || croissanceCA10ans === null ? '' : 
    <div>
        <div className="progress">
            <div className={getProgressClass(croissanceCA10ans)} role="progressbar" style={{ width: `${croissanceCA10ans}%` }} aria-valuenow={croissanceCA10ans} aria-valuemin="0" aria-valuemax="100"></div>
        </div>
        <p>Croissance CA 10 ans : {croissanceCA10ans}%</p>
    </div>
}
