...
<p className="text-muted">Roce 1 an : {roce23} %</p>
<p className="text-muted">Roce 5 ans : {pct1} %</p>
<p className="text-muted">{cagr5Years !== null ? `${cagr5Years}%` : 'Calcul en cours...'}</p>
<p className="text-muted">Payout Ratio de {symbol} : {payoutRatio}%</p>
<p className="text-muted">Free Cash Flow Margin 1 an : {fcfMarginOneYear}%</p>
<p className="text-muted">Free Cash Flow Margin 5 ans : {averageMarginFiveYears}%</p>
<p className="text-muted">Croissance Annualisée du Dividende : {annualizedGrowthRate}%</p>
<p className="text-muted">Croissance du résultat net sur 1 an: {netIncomeGrowthOneYear}%</p>
<p className="text-muted">Croissance du résultat net sur 5 ans: {netIncomeGrowthFiveYears}%</p>
<p className="text-muted">Croissance du résultat net sur 10 ans: {netIncomeGrowthTenYears}%</p>
<p className="text-muted">Capex / Résultat net (moyenne 5 ans) : {averageRatio}%</p>
<p className="text-muted">Debt to Equity Ratio de : {debtToEquityRatio}</p>
<p className="text-muted">Rachat net moyen d'actions (moyenne 5 ans) {symbol}: {netSharesRepurchases}</p>
<p className="text-muted">Croissance moyenne du dividende sur 5 ans {symbol}: {growthRate.toFixed(2)} %</p>
<p className="text-muted">Le dividende n'a pas diminué depuis {currentStreak} an(s)</p>
<p className="text-muted">CAGR sur 1 an : {cagr1Year1}</p>
<p className="text-muted">CAGR sur 5 ans : {cagr5Years}</p>
<p className="text-muted">CAGR sur 10 ans : {cagr10Years3}</p>
<p className="text-muted">Total Piotroski Score: {totalScore} / 9 points</p>
