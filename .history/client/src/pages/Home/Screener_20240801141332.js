...
export default function Screener() {
  ...
  const handleError = async (e) => {
    ...
    // Essayer de récupérer le logo depuis FinancialGrep
    ...
    try {
      ...
      if (res.data.logoUrl) {
        ...
        // Afficher "Logo indisponible" si FinancialGrep ne fournit pas de logo
        logoElement.textContent = 'Logo indisponible';
      }
    } catch (error) {
      console.error('Error fetching logo from FinancialGrep:', error);
      logoElement.textContent = 'Logo indisponible'; // En cas d'erreur, afficher "Logo indisponible"
    }
  };
