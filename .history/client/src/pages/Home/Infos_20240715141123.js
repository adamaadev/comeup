 ...
 useEffect(() => {
  ...
  return (
    ...
    <div className="accordion" id="accordionCategories">
      {/* Croissance */}
      <div className="card">
        <div className="card-header" id="headingCroissance">
          <h2 className="mb-0">
            <button
              className="btn btn-link"
              type="button"
              data-toggle="collapse"
              data-target="#collapseCroissance"
              aria-expanded="true"
        ...
        <div
          id="collapseCroissance"
          className="collapse show"
          aria-labelledby="headingCroissance"
          data-parent="#accordionCategories"
        >
          <div className="card-body">
            {isNaN(pct1) || !isFinite(pct1) ? '' : <p>Roce 5 ans : {pct1} %</p>}
            {isNaN(cagr1Year1) || !isFinite(cagr1Year1) ? '' : <p>FCF 1 an : {`${cagr1Year1}%`}</p>}
            {isNaN(cagr5Years2) || !isFinite(cagr5Years2) ? '' : <p>FCF sur 5 ans : {`${cagr5Years2}%`}</p>}
            {isNaN(cagr10Years3) || !isFinite(cagr10Years3) ? '' : <p>FCF sur 10 ans : {`${cagr10Years3}%`}</p>}
          </div>
        </div>
      </div>
      ...
      {/* Profits */}
      <div className="card">
        <div className="card-header" id="headingProfits">
          <h2 className="mb-0">
            <button
              className="btn btn-link collapsed"
              type="button"
              data-toggle="collapse"
              data-target="#collapseProfits"
              aria-expanded="false"
              aria-controls="collapseProfits"
            >
              Profits
            </button>
          </h2>
        ...
        <div
          id="collapseProfits"
          className="collapse"
          aria-labelledby="headingProfits"
          data-parent="#accordionCategories"
        >
          <div className="card-body">
            {isNaN(netIncomeGrowth1Year) || !isFinite(netIncomeGrowth1Year) ? '' : <p>Résultat Net 1 an : {netIncomeGrowth1Year}%</p>}
            {isNaN(netIncomeGrowth5Years) || !isFinite(netIncomeGrowth5Years) ? '' : <p>Résultat Net 5 ans : {netIncomeGrowth5Years}%</p>}
            {isNaN(averageRatio) || !isFinite(averageRatio) ? '' : <p>Capex / Résultat net (moyenne 5 ans) : {averageRatio}%</p>}
          </div>
        </div>
      </div>
      ...
      {/* Rentabilité */}
      <div className="card">
        <div className="card-header" id="headingRentabilite">
          <h2 className="mb-0">
            <button
              className="btn btn-link collapsed"
              type="button"
              data-toggle="collapse"
              data-target="#collapseRentabilite"
              aria-expanded="false"
              aria-controls="collapseRentabilite"
            >
              Rentabilité
            </button>
          </h2>
        ...
        <div
          id="collapseRentabilite"
          className="collapse"
          aria-labelledby="headingRentabilite"
          data-parent="#accordionCategories"
        >
          <div className="card-body">
            {isNaN(roce1Year) || !isFinite(roce1Year) ? '' : <p>ROCE 1 an : {roce1Year}%</p>}
            {isNaN(roce5Years) || !isFinite(roce5Years) ? '' : <p>ROCE 5 ans : {roce5Years}%</p>}
            {isNaN(fcfMargin1Year) || !isFinite(fcfMargin1Year) ? '' : <p>FCF Margin 1 an : {fcfMargin1Year}%</p>}
            {isNaN(fcfMargin5Years) || !isFinite(fcfMargin5Years) ? '' : <p>FCF Margin 5 ans : {fcfMargin5Years}%</p>}
          </div>
        </div>
      </div>
      ...
      {/* Santé */}
      <div className="card">
        <div className="card-header" id="headingSante">
          <h2 className="mb-0">
            <button
              className="btn btn-link collapsed"
              type="button"
              data-toggle="collapse"
              data-target="#collapseSante"
              aria-expanded="false"
              aria-controls="collapseSante"
            >
              Santé
            </button>
          </h2>
        ...
        <div
          id="collapseSante"
          className="collapse"
          aria-labelledby="headingSante"
          data-parent="#accordionCategories"
        >
          <div className="card-body">
            {isNaN(debtToEquityRatio) || !isFinite(debtToEquityRatio) ? '' : <p>Debt/Equity Ratio : {debtToEquityRatio}</p>}
            {isNaN(payoutRatio) || !isFinite(payoutRatio) ? '' : <p>Payout Ratio : {payoutRatio}%</p>}
          </div>
        </div>
      </div>
      ...
      {/* Dividende */}
      <div className="card">
        <div className="card-header" id="headingDividende">
          <h2 className="mb-0">
            <button
              className="btn btn-link collapsed"
              type="button"
              data-toggle="collapse"
              data-target="#collapseDividende"
              aria-expanded="false"
              aria-controls="collapseDividende"
            >
              Dividende
            </button>
          </h2>
        ...
        <div
          id="collapseDividende"
          className="collapse"
          aria-labelledby="headingDividende"
          data-parent="#accordionCategories"
        >
          <div className="card-body">
            {isNaN(netIncomeGrowth1Year) || !isFinite(netIncomeGrowth1Year) ? '' : <p>Croissance 1 an : {netIncomeGrowth1Year}%</p>}
            {isNaN(growthRate) || !isFinite(growthRate) ? '' : <p>Croissance Moyenne 5 ans : {growthRate}%</p>}
            {isNaN(currentStreak) || !isFinite(currentStreak) ? '' : <p>Année Sans Interruption : {currentStreak} an(s)</p>}
            {isNaN(currentStreak) || !isFinite(currentStreak) ? '' : <p>Année Sans Diminution : {currentStreak} an(s)</p>}
            {isNaN(buybackYield) || !isFinite(buybackYield) ? '' : <p>Buyback Yield : {buybackYield}%</p>}
            {isNaN(piotroskiScore) || !isFinite(piotroskiScore) ? '' : <p>Piotroski-Score : {piotroskiScore}</p>}
          </div>
        </div>
      </div>
      ...
      {/* Autre */}
      <div className="card">
        <div className="card-header" id="headingAutre">
          <h2 className="mb-0">
            <button
              className="btn btn-link collapsed"
              type="button"
              data-toggle="collapse"
              data-target="#collapseAutre"
              aria-expanded="false"
              aria-controls="collapseAutre"
            >
              Autre
            </button>
          </h2>
