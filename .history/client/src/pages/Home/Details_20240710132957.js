...
export default function Details() {
  ...
  const [selectedResponse, setSelectedResponse] = useState("oui"); // State for selected response
  ...
  const handleSubmit = () => {
    // Code to handle form submission, e.g., send data to backend or display it
    console.log("Réponse choisie:", selectedResponse);
    console.log("Justification:", justification);
    // Example: Displaying data in console, you can modify to send data to backend or display elsewhere
  };
