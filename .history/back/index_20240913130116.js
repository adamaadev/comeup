  ...
  try {
    const session = await stripe.checkout.sessions.create({
      ...
      subscription_data: {
        items: [
          {
            price: 'price_1PqNAaFTPbYwB9q1b2pA90nF', // Remplacez par l'ID de votre prix d'abonnement
          },
        ],
      },
      mode: 'subscription',
      success_url: 'http://localhost:3000/success', // URL vers laquelle l'utilisateur sera redirigé après un paiement réussi
      cancel_url: 'http://localhost:3000/cancel', // URL vers laquelle l'utilisateur sera redirigé après un paiement annulé
    });
