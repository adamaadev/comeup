...
app.post('/webhook', express.raw({ type: 'application/json' }), async (req, res) => {
  ...
  try {
      event = stripe.webhooks.constructEvent(req.body, sig, process.env.whsec_ebb9f10c1497412cc0c1777ea70f40937ad7230672abdd49f8db96828557c8c2);
  } catch (err) {
  ...
  if (event.type === 'checkout.session.completed') {
      ...
      const email = session.customer_email; // Assume the email is in the session
