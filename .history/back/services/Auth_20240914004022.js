              ...
              if (result.length > 0) {
                ...
                bcrypt.hash(password, 10, (err, hash) => {
                  if (err) {
                    ...
                    con.query('INSERT INTO utilisateurs (id, username, email, password, essaie, status, type, carte, date_debut, date_fin, plan) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', 
[null, username, email, hash, "false", "inactive", type, null, null, null, "aucun"], (err, success) => {
                      if (success) {
