  ...
  con.query(query, (error, results) => {
    ...
    if (results && results.length > 0) {
      ...
      const notations = {
        ...
        fcf_margin_one_year: evaluateRatio(result.fcf_margin_one_year),
        fcf_margin_five_year: evaluateRatio(result.fcf_margin_five_year),
        ...
        rachat_net_moyen: result.rachat_net_moyen,
        nbreannee: result.nbreannee,
        quanti: result.quanti
      };

      res.send({ ...result, notations });
    } else {
