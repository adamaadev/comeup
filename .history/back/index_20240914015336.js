...
app.post('/create-checkout-session', async (req, res) => {
  ...
  if (plan === 'FREE') {
    priceId = 'price_1Pyk7JFTPbYwB9q1UCGceLhD'; // Remplacez par l'ID de prix réel du produit FREE sur Stripe
  } else if (plan === 'STARTER') {
    priceId = 'price_1PqNAaFTPbYwB9q1b2pA90nF'; // ID de prix du produit STARTER
  } else if (plan === 'PREMIUM') {
    priceId = 'price_1PqhMcFTPbYwB9q16TEha35N'; // ID de prix du produit PREMIUM
  }
