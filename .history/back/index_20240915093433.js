...
app.get('/subscribe', async (req, res) => {
  ...
  switch (plan.toLowerCase()) {
    case 'starter':
      priceId = 'price_1PqNAaFTPbYwB9q1b2pA90nF'; // Remplacez par le bon priceId
      break;

    case 'pro':
      priceId = 'price_1PqNBHFTPbYwB9q1c2pA90nF'; // Assurez-vous d'avoir un priceId différent pour 'pro'
      break;
